...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Pi,depthTest:!1,depthWrite:!1})}function Qf(){return new Ni({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ku(),fragmentShader:`
		...
		`,blending:Pi,depthTest:!1,depthWrite:!1})}function eh(){return new Ni({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ku(),fragmentShader:`
...
}`;class NM{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t,i){if(this.texture===null){const r=new Vt,s=e.properties.get(r);s.__webglTexture=t.texture,(t.depthNear!==i.depthNear||t.depthFar!==i.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=r}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,i=new Ni({vertexShader:DM,fragmentShader:UM,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Tn(new Wa(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class FM extends cs{constructor(e,t){super();const i=this;let r=null,s=1,o=null,a="local-floor",l=1,c=null,u=null,f=null,h=null,d=null,g=null;const _=new NM,m=t.getContextAttributes();let p=null,E=null;const S=[],M=[],L=new Ve;let P=null;const R=new sn;R.viewport=new Ct;const I=new sn;I.viewport=new Ct;const A=[R,I],y=new i4;let w=null,U=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(ie){let _e=S[ie];return _e===void 0&&(_e=new Vl,S[ie]=_e),_e.getTargetRaySpace()},this.getControllerGrip=function(ie){let _e=S[ie];return _e===void 0&&(_e=new Vl,S[ie]=_e),_e.getGripSpace()},this.getHand=function(ie){let _e=S[ie];return _e===void 0&&(_e=new Vl,S[ie]=_e),_e.getHandSpace()};function D(ie){const _e=M.indexOf(ie.inputSource);if(_e===-1)return;const J=S[_e];J!==void 0&&(J.update(ie.inputSource,ie.frame,c||o),J.dispatchEvent({type:ie.type,data:ie.inputSource}))}function G(){r.removeEventListener("select",D),r.removeEventListener("selectstart",D),r.removeEventListener("selectend",D),r.removeEventListener("squeeze",D),r.removeEventListener("squeezestart",D),r.removeEventListener("squeezeend",D),r.removeEventListener("end",G),r.removeEventListener("inputsourceschange",W);for(let ie=0;ie<S.length;ie++){const _e=M[ie];_e!==null&&(M[ie]=null,S[ie].disconnect(_e))}w=null,U=null,_.reset(),e.setRenderTarget(p),d=null,h=null,f=null,r=null,E=null,Oe.stop(),i.isPresenting=!1,e.setPixelRatio(P),e.setSize(L.width,L.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(ie){s=ie,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(ie){a=ie,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function(ie){c=ie},this.getBaseLayer=function(){return h!==null?h:d},this.getBinding=function(){return f},this.getFrame=function(){return g},this.getSession=function(){return r},this.setSession=async function(ie){if(r=ie,r!==null){if(p=e.getRenderTarget(),r.addEventListener("select",D),r.addEventListener("selectstart",D),r.addEventListener("selectend",D),r.addEventListener("squeeze",D),r.addEventListener("squeezestart",D),r.addEventListener("squeezeend",D),r.addEventListener("end",G),r.addEventListener("inputsourceschange",W),m.xrCompatible!==!0&&await t.makeXRCompatible(),P=e.getPixelRatio(),e.getSize(L),typeof XRWebGLBinding<"u"&&"createProjectionLayer"in XRWebGLBinding.prototype){let J=null,N=null,re=null;m.depth&&(re=m.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,J=m.stencil?Ys:qs,N=m.stencil?$s:dr);const ae={colorFormat:t.RGBA8,depthFormat:re,scaleFactor:s};f=new XRWebGLBinding(r,t),h=f.createProjectionLayer(ae),r.updateRenderState({layers:[h]}),e.setPixelRatio(1),e.setSize(h.textureWidth,h.textureHeight,!1),E=new pr(h.textureWidth,h.textureHeight,{format:Cn,type:ci,depthTexture:new R2(h.textureWidth,h.textureHeight,N,void 0,void 0,void 0,void 0,void 0,void 0,J),stencilBuffer:m.stencil,colorSpace:e.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:h.ignoreDepthValues===!1,resolveStencilBuffer:h.ignoreDepthValues===!1})}else{const J={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:s};d=new XRWebGLLayer(r,t,J),r.updateRenderState({baseLayer:d}),e.setPixelRatio(1),e.setSize(d.framebufferWidth,d.framebufferHeight,!1),E=new pr(d.framebufferWidth,d.framebufferHeight,{format:Cn,type:ci,colorSpace:e.outputColorSpace,stencilBuffer:m.stencil,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}E.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await r.requestReferenceSpace(a),Oe.setContext(r),Oe.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function W(ie){for(let _e=0;_e<ie.removed.length;_e++){const J=ie.removed[_e],N=M.indexOf(J);N>=0&&(M[N]=null,S[N].disconnect(J))}for(let _e=0;_e<ie.added.length;_e++){const J=ie.added[_e];let N=M.indexOf(J);if(N===-1){for(let ae=0;ae<S.length;ae++)if(ae>=M.length){M.push(J),N=ae;break}else if(M[ae]===null){M[ae]=J,N=ae;break}if(N===-1)break}const re=S[N];re&&re.connect(J)}}const $=new H,q=new H;function O(ie,_e,J){$.setFromMatrixPosition(_e.matrixWorld),q.setFromMatrixPosition(J.matrixWorld);const N=$.distanceTo(q),re=_e.projectionMatrix.elements,ae=J.projectionMatrix.elements,le=re[14]/(re[10]-1),Ne=re[14]/(re[10]+1),ze=(re[9]+1)/re[5],C=(re[9]-1)/re[5],v=(re[8]-1)/re[0],k=(ae[8]+1)/ae[0],ne=le*v,j=le*k,Y=N/(-v+k),de=Y*-v;if(_e.matrixWorld.decompose(ie.position,ie.quaternion,ie.scale),ie.translateX(de),ie.translateZ(Y),ie.matrixWorld.compose(ie.position,ie.quaternion,ie.scale),ie.matrixWorldInverse.copy(ie.matrixWorld).invert(),re[10]===-1)ie.projectionMatrix.copy(_e.projectionMatrix),ie.projectionMatrixInverse.copy(_e.projectionMatrixInverse);else{const oe=le+Y,ce=Ne+Y,fe=ne-de,b=j+(N-de),x=ze*Ne/ce*oe,F=C*Ne/ce*oe;ie.projectionMatrix.makePerspective(fe,b,x,F,oe,ce),ie.projectionMatrixInverse.copy(ie.projectionMatrix).invert()}}function se(ie,_e){_e===null?ie.matrixWorld.copy(ie.matrix):ie.matrixWorld.multiplyMatrices(_e.matrixWorld,ie.matrix),ie.matrixWorldInverse.copy(ie.matrixWorld).invert()}this.updateCamera=function(ie){if(r===null)return;let _e=ie.near,J=ie.far;_.texture!==null&&(_.depthNear>0&&(_e=_.depthNear),_.depthFar>0&&(J=_.depthFar)),y.near=I.near=R.near=_e,y.far=I.far=R.far=J,(w!==y.near||U!==y.far)&&(r.updateRenderState({depthNear:y.near,depthFar:y.far}),w=y.near,U=y.far),R.layers.mask=ie.layers.mask|2,I.layers.mask=ie.layers.mask|4,y.layers.mask=R.layers.mask|I.layers.mask;const N=ie.parent,re=y.cameras;se(y,N);for(let ae=0;ae<re.length;ae++)se(re[ae],N);re.length===2?O(y,R,I):y.projectionMatrix.copy(R.projectionMatrix),K(ie,y,N)};function K(ie,_e,J){J===null?ie.matrix.copy(_e.matrixWorld):(ie.matrix.copy(J.matrixWorld),ie.matrix.invert(),ie.matrix.multiply(_e.matrixWorld)),ie.matrix.decompose(ie.position,ie.quaternion,ie.scale),ie.updateMatrixWorld(!0),ie.projectionMatrix.copy(_e.projectionMatrix),ie.projectionMatrixInverse.copy(_e.projectionMatrixInverse),ie.isPerspectiveCamera&&(ie.fov=iu*2*Math.atan(1/ie.projectionMatrix.elements[5]),ie.zoom=1)}this.getCamera=function(){return y},this.getFoveation=function(){if(!(h===null&&d===null))return l},this.setFoveation=function(ie){l=ie,h!==null&&(h.fixedFoveation=ie),d!==null&&d.fixedFoveation!==void 0&&(d.fixedFoveation=ie)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(y)};let ue=null;function Ee(ie,_e){if(u=_e.getViewerPose(c||o),g=_e,u!==null){const J=u.views;d!==null&&(e.setRenderTargetFramebuffer(E,d.framebuffer),e.setRenderTarget(E));let N=!1;J.length!==y.cameras.length&&(y.cameras.length=0,N=!0);for(let le=0;le<J.length;le++){const Ne=J[le];let ze=null;if(d!==null)ze=d.getViewport(Ne);else{const v=f.getViewSubImage(h,Ne);ze=v.viewport,le===0&&(e.setRenderTargetTextures(E,v.colorTexture,v.depthStencilTexture),e.setRenderTarget(E))}let C=A[le];C===void 0&&(C=new sn,C.layers.enable(le),C.viewport=new Ct,A[le]=C),C.matrix.fromArray(Ne.transform.matrix),C.matrix.decompose(C.position,C.quaternion,C.scale),C.projectionMatrix.fromArray(Ne.projectionMatrix),C.projectionMatrixInverse.copy(C.projectionMatrix).invert(),C.viewport.set(ze.x,ze.y,ze.width,ze.height),le===0&&(y.matrix.copy(C.matrix),y.matrix.decompose(y.position,y.quaternion,y.scale)),N===!0&&y.cameras.push(C)}const re=r.enabledFeatures;if(re&&re.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&f){const le=f.getDepthInformation(J[0]);le&&le.isValid&&le.texture&&_.init(e,le,r.renderState)}}for(let J=0;J<S.length;J++){const N=M[J],re=S[J];N!==null&&re!==void 0&&re.update(N,_e,c||o)}ue&&ue(ie,_e),_e.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:_e}),g=null}const Oe=new D2;Oe.setAnimationLoop(Ee),this.setAnimationLoop=function(ie){ue=ie},this.dispose=function(){}}}const Qi=new zn,OM=new Mt;function BM(n,e){function t(m,p){m.matrixAutoUpdate===!0&&m.updateMatrix(),p.value.copy(m.matrix)}function i(m,p){p.color.getRGB(m.fogColor.value,y2(n)),p.isFog?(m.fogNear.value=p.near,m.fogFar.value=p.far):p.isFogExp2&&(m.fogDensity.value=p.density)}function r(m,p,E,S,M){p.isMeshBasicMaterial||p.isMeshLambertMaterial?s(m,p):p.isMeshToonMaterial?(s(m,p),f(m,p)):p.isMeshPhongMaterial?(s(m,p),u(m,p)):p.isMeshStandardMaterial?(s(m,p),h(m,p),p.isMeshPhysicalMaterial&&d(m,p,M)):p.isMeshMatcapMaterial?(s(m,p),g(m,p)):p.isMeshDepthMaterial?s(m,p):p.isMeshDistanceMaterial?(s(m,p),_(m,p)):p.isMeshNormalMaterial?s(m,p):p.isLineBasicMaterial?(o(m,p),p.isLineDashedMaterial&&a(m,p)):p.isPointsMaterial?l(m,p,E,S):p.isSpriteMaterial?c(m,p):p.isShadowMaterial?(m.color.value.copy(p.color),m.opacity.value=p.opacity):p.isShaderMaterial&&(p.uniformsNeedUpdate=!1)}function s(m,p){m.opacity.value=p.opacity,p.color&&m.diffuse.value.copy(p.color),p.emissive&&m.emissive.value.copy(p.emissive).multiplyScalar(p.emissiveIntensity),p.map&&(m.map.value=p.map,t(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,t(p.alphaMap,m.alphaMapTransform)),p.bumpMap&&(m.bumpMap.value=p.bumpMap,t(p.bumpMap,m.bumpMapTransform),m.bumpScale.value=p.bumpScale,p.side===Kt&&(m.bumpScale.value*=-1)),p.normalMap&&(m.normalMap.value=p.normalMap,t(p.normalMap,m.normalMapTransform),m.normalScale.value.copy(p.normalScale),p.side===Kt&&m.normalScale.value.negate()),p.displacementMap&&(m.displacementMap.value=p.displacementMap,t(p.displacementMap,m.displacementMapTransform),m.displacementScale.value=p.displacementScale,m.displacementBias.value=p.displacementBias),p.emissiveMap&&(m.emissiveMap.value=p.emissiveMap,t(p.emissiveMap,m.emissiveMapTransform)),p.specularMap&&(m.specularMap.value=p.specularMap,t(p.specularMap,m.specularMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest);const E=e.get(p),S=E.envMap,M=E.envMapRotation;S&&(m.envMap.value=S,Qi.copy(M),Qi.x*=-1,Qi.y*=-1,Qi.z*=-1,S.isCubeTexture&&S.isRenderTargetTexture===!1&&(Qi.y*=-1,Qi.z*=-1),m.envMapRotation.value.setFromMatrix4(OM.makeRotationFromEuler(Qi)),m.flipEnvMap.value=S.isCubeTexture&&S.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=p.reflectivity,m.ior.value=p.ior,m.refractionRatio.value=p.refractionRatio),p.lightMap&&(m.lightMap.value=p.lightMap,m.lightMapIntensity.value=p.lightMapIntensity,t(p.lightMap,m.lightMapTransform)),p.aoMap&&(m.aoMap.value=p.aoMap,m.aoMapIntensity.value=p.aoMapIntensity,t(p.aoMap,m.aoMapTransform))}function o(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,p.map&&(m.map.value=p.map,t(p.map,m.mapTransform))}function a(m,p){m.dashSize.value=p.dashSize,m.totalSize.value=p.dashSize+p.gapSize,m.scale.value=p.scale}function l(m,p,E,S){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.size.value=p.size*E,m.scale.value=S*.5,p.map&&(m.map.value=p.map,t(p.map,m.uvTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,t(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function c(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.rotation.value=p.rotation,p.map&&(m.map.value=p.map,t(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,t(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function u(m,p){m.specular.value.copy(p.specular),m.shininess.value=Math.max(p.shininess,1e-4)}function f(m,p){p.gradientMap&&(m.gradientMap.value=p.gradientMap)}function h(m,p){m.metalness.value=p.metalness,p.metalnessMap&&(m.metalnessMap.value=p.metalnessMap,t(p.metalnessMap,m.metalnessMapTransform)),m.roughness.value=p.roughness,p.roughnessMap&&(m.roughnessMap.value=p.roughnessMap,t(p.roughnessMap,m.roughnessMapTransform)),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)}function d(m,p,E){m.ior.value=p.ior,p.sheen>0&&(m.sheenColor.value.copy(p.sheenColor).multiplyScalar(p.sheen),m.sheenRoughness.value=p.sheenRoughness,p.sheenColorMap&&(m.sheenColorMap.value=p.sheenColorMap,t(p.sheenColorMap,m.sheenColorMapTransform)),p.sheenRoughnessMap&&(m.sheenRoughnessMap.value=p.sheenRoughnessMap,t(p.sheenRoughnessMap,m.sheenRoughnessMapTransform))),p.clearcoat>0&&(m.clearcoat.value=p.clearcoat,m.clearcoatRoughness.value=p.clearcoatRoughness,p.clearcoatMap&&(m.clearcoatMap.value=p.clearcoatMap,t(p.clearcoatMap,m.clearcoatMapTransform)),p.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=p.clearcoatRoughnessMap,t(p.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),p.clearcoatNormalMap&&(m.clearcoatNormalMap.value=p.clearcoatNormalMap,t(p.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(p.clearcoatNormalScale),p.side===Kt&&m.clearcoatNormalScale.value.negate())),p.dispersion>0&&(m.dispersion.value=p.dispersion),p.iridescence>0&&(m.iridescence.value=p.iridescence,m.iridescenceIOR.value=p.iridescenceIOR,m.iridescenceThicknessMinimum.value=p.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=p.iridescenceThicknessRange[1],p.iridescenceMap&&(m.iridescenceMap.value=p.iridescenceMap,t(p.iridescenceMap,m.iridescenceMapTransform)),p.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=p.iridescenceThicknessMap,t(p.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),p.transmission>0&&(m.transmission.value=p.transmission,m.transmissionSamplerMap.value=E.texture,m.transmissionSamplerSize.value.set(E.width,E.height),p.transmissionMap&&(m.transmissionMap.value=p.transmissionMap,t(p.transmissionMap,m.transmissionMapTransform)),m.thickness.value=p.thickness,p.thicknessMap&&(m.thicknessMap.value=p.thicknessMap,t(p.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=p.attenuationDistance,m.attenuationColor.value.copy(p.attenuationColor)),p.anisotropy>0&&(m.anisotropyVector.value.set(p.anisotropy*Math.cos(p.anisotropyRotation),p.anisotropy*Math.sin(p.anisotropyRotation)),p.anisotropyMap&&(m.anisotropyMap.value=p.anisotropyMap,t(p.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=p.specularIntensity,m.specularColor.value.copy(p.specularColor),p.specularColorMap&&(m.specularColorMap.value=p.specularColorMap,t(p.specularColorMap,m.specularColorMapTransform)),p.specularIntensityMap&&(m.specularIntensityMap.value=p.specularIntensityMap,t(p.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,p){p.matcap&&(m.matcap.value=p.matcap)}function _(m,p){const E=e.get(p).light;m.referencePosition.value.setFromMatrixPosition(E.matrixWorld),m.nearDistance.value=E.shadow.camera.near,m.farDistance.value=E.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function HM(n,e,t,i){let r={},s={},o=[];const a=n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS);function l(E,S){const M=S.program;i.uniformBlockBinding(E,M)}function c(E,S){let M=r[E.id];M===void 0&&(g(E),M=u(E),r[E.id]=M,E.addEventListener("dispose",m));const L=S.program;i.updateUBOMapping(E,L);const P=e.render.frame;s[E.id]!==P&&(h(E),s[E.id]=P)}function u(E){const S=f();E.__bindingPointIndex=S;const M=n.createBuffer(),L=E.__size,P=E.usage;return n.bindBuffer(n.UNIFORM_BUFFER,M),n.bufferData(n.UNIFORM_BUFFER,L,P),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,S,M),M}function f(){for(let E=0;E<a;E++)if(o.indexOf(E)===-1)return o.push(E),E;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(E){const S=r[E.id],M=E.uniforms,L=E.__cache;n.bindBuffer(n.UNIFORM_BUFFER,S);for(let P=0,R=M.length;P<R;P++){const I=Array.isArray(M[P])?M[P]:[M[P]];for(let A=0,y=I.length;A<y;A++){const w=I[A];if(d(w,P,A,L)===!0){const U=w.__offset,D=Array.isArray(w.value)?w.value:[w.value];let G=0;for(let W=0;W<D.length;W++){const $=D[W],q=_($);typeof $=="number"||typeof $=="boolean"?(w.__data[0]=$,n.bufferSubData(n.UNIFORM_BUFFER,U+G,w.__data)):$.isMatrix3?(w.__data[0]=$.elements[0],w.__data[1]=$.elements[1],w.__data[2]=$.elements[2],w.__data[3]=0,w.__data[4]=$.elements[3],w.__data[5]=$.elements[4],w.__data[6]=$.elements[5],w.__data[7]=0,w.__data[8]=$.elements[6],w.__data[9]=$.elements[7],w.__data[10]=$.elements[8],w.__data[11]=0):($.toArray(w.__data,G),G+=q.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,U,w.__data)}}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function d(E,S,M,L){const P=E.value,R=S+"_"+M;if(L[R]===void 0)return typeof P=="number"||typeof P=="boolean"?L[R]=P:L[R]=P.clone(),!0;{const I=L[R];if(typeof P=="number"||typeof P=="boolean"){if(I!==P)return L[R]=P,!0}else if(I.equals(P)===!1)return I.copy(P),!0}return!1}function g(E){const S=E.uniforms;let M=0;const L=16;for(let R=0,I=S.length;R<I;R++){const A=Array.isArray(S[R])?S[R]:[S[R]];for(let y=0,w=A.length;y<w;y++){const U=A[y],D=Array.isArray(U.value)?U.value:[U.value];for(let G=0,W=D.length;G<W;G++){const $=D[G],q=_($),O=M%L,se=O%q.boundary,K=O+se;M+=se,K!==0&&L-K<q.storage&&(M+=L-K),U.__data=new Float32Array(q.storage/Float32Array.BYTES_PER_ELEMENT),U.__offset=M,M+=q.storage}}}const P=M%L;return P>0&&(M+=L-P),E.__size=M,E.__cache={},this}function _(E){const S={boundary:0,storage:0};return typeof E=="number"||typeof E=="boolean"?(S.boundary=4,S.storage=4):E.isVector2?(S.boundary=8,S.storage=8):E.isVector3||E.isColor?(S.boundary=16,S.storage=12):E.isVector4?(S.boundary=16,S.storage=16):E.isMatrix3?(S.boundary=48,S.storage=48):E.isMatrix4?(S.boundary=64,S.storage=64):E.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",E),S}function m(E){const S=E.target;S.removeEventListener("dispose",m);const M=o.indexOf(S.__bindingPointIndex);o.splice(M,1),n.deleteBuffer(r[S.id]),delete r[S.id],delete s[S.id]}function p(){for(const E in r)n.deleteBuffer(r[E]);o=[],r={},s={}}return{bind:l,update:c,dispose:p}}class B2{constructor(e={}){const{canvas:t=tv(),context:i=null,depth:r=!0,stencil:s=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:f=!1,reverseDepthBuffer:h=!1}=e;this.isWebGLRenderer=!0;let d;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");d=i.getContextAttributes().alpha}else d=o;const g=new Uint32Array(4),_=new Int32Array(4);let m=null,p=null;const E=[],S=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Li,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const M=this;let L=!1;this._outputColorSpace=hn;let P=0,R=0,I=null,A=-1,y=null;const w=new Ct,U=new Ct;let D=null;const G=new et(0);let W=0,$=t.width,q=t.height,O=1,se=null,K=null;const ue=new Ct(0,0,$,q),Ee=new Ct(0,0,$,q);let Oe=!1;const ie=new A2;let _e=!1,J=!1;const N=new Mt,re=new Mt,ae=new H,le=new Ct,Ne={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let ze=!1;function C(){return I===null?O:1}let v=i;function k(T,z){return t.getContext(T,z)}try{const T={alpha:!0,depth:r,stencil:s,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:f};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Ou}`),t.addEventListener("webglcontextlost",Ie,!1),t.addEventListener("webglcontextrestored",xe,!1),t.addEventListener("webglcontextcreationerror",he,!1),v===null){const z="webgl2";if(v=k(z,T),v===null)throw k(z)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(T){throw console.error("THREE.WebGLRenderer: "+T.message),T}let ne,j,Y,de,oe,ce,fe,b,x,F,X,ee,Z,Me,ve,be,Le,pe,we,Be,Pe,ye,ke,B;function Te(){ne=new K5(v),ne.init(),ye=new IM(v,ne),j=new G5(v,ne,e,ye),Y=new PM(v,ne),j.reverseDepthBuffer&&h&&Y.buffers.depth.setReversed(!0),de=new Q5(v),oe=new _M,ce=new LM(v,ne,Y,oe,j,ye,de),fe=new X5(M),b=new Z5(M),x=new s4(v),ke=new V5(v,x),F=new j5(v,x,de,ke),X=new tS(v,F,x,de),we=new eS(v,j,ce),be=new W5(oe),ee=new gM(M,fe,b,ne,j,ke,be),Z=new BM(M,oe),Me=new xM,ve=new TM(ne),pe=new z5(M,fe,b,Y,X,d,l),Le=new wM(M,X,j),B=new HM(v,de,j,Y),Be=new k5(v,ne,de),Pe=new J5(v,ne,de),de.programs=ee.programs,M.capabilities=j,M.extensions=ne,M.properties=oe,M.renderLists=Me,M.shadowMap=Le,M.state=Y,M.info=de}Te();const me=new FM(M,v);this.xr=me,this.getContext=function(){return v},this.getContextAttributes=function(){return v.getContextAttributes()},this.forceContextLoss=function(){const T=ne.get("WEBGL_lose_context");T&&T.loseContext()},this.forceContextRestore=function(){const T=ne.get("WEBGL_lose_context");T&&T.restoreContext()},this.getPixelRatio=function(){return O},this.setPixelRatio=function(T){T!==void 0&&(O=T,this.setSize($,q,!1))},this.getSize=function(T){return T.set($,q)},this.setSize=function(T,z,Q=!0){if(me.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}$=T,q=z,t.width=Math.floor(T*O),t.height=Math.floor(z*O),Q===!0&&(t.style.width=T+"px",t.style.height=z+"px"),this.setViewport(0,0,T,z)},this.getDrawingBufferSize=function(T){return T.set($*O,q*O).floor()},this.setDrawingBufferSize=function(T,z,Q){$=T,q=z,O=Q,t.width=Math.floor(T*Q),t.height=Math.floor(z*Q),this.setViewport(0,0,T,z)},this.getCurrentViewport=function(T){return T.copy(w)},this.getViewport=function(T){return T.copy(ue)},this.setViewport=function(T,z,Q,te){T.isVector4?ue.set(T.x,T.y,T.z,T.w):ue.set(T,z,Q,te),Y.viewport(w.copy(ue).multiplyScalar(O).round())},this.getScissor=function(T){return T.copy(Ee)},this.setScissor=function(T,z,Q,te){T.isVector4?Ee.set(T.x,T.y,T.z,T.w):Ee.set(T,z,Q,te),Y.scissor(U.copy(Ee).multiplyScalar(O).round())},this.getScissorTest=function(){return Oe},this.setScissorTest=function(T){Y.setScissorTest(Oe=T)},this.setOpaqueSort=function(T){se=T},this.setTransparentSort=function(T){K=T},this.getClearColor=function(T){return T.copy(pe.getClearColor())},this.setClearColor=function(){pe.setClearColor(...arguments)},this.getClearAlpha=function(){return pe.getClearAlpha()},this.setClearAlpha=function(){pe.setClearAlpha(...arguments)},this.clear=function(T=!0,z=!0,Q=!0){let te=0;if(T){let V=!1;if(I!==null){const Se=I.texture.format;V=Se===Gu||Se===ku||Se===Vu}if(V){const Se=I.texture.type,Ae=Se===ci||Se===dr||Se===Xs||Se===$s||Se===Hu||Se===zu,Ue=pe.getClearColor(),Re=pe.getClearAlpha(),Ge=Ue.r,We=Ue.g,Fe=Ue.b;Ae?(g[0]=Ge,g[1]=We,g[2]=Fe,g[3]=Re,v.clearBufferuiv(v.COLOR,0,g)):(_[0]=Ge,_[1]=We,_[2]=Fe,_[3]=Re,v.clearBufferiv(v.COLOR,0,_))}else te|=v.COLOR_BUFFER_BIT}z&&(te|=v.DEPTH_BUFFER_BIT),Q&&(te|=v.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),v.clear(te)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",Ie,!1),t.removeEventListener("webglcontextrestored",xe,!1),t.removeEventListener("webglcontextcreationerror",he,!1),pe.dispose(),Me.dispose(),ve.dispose(),oe.dispose(),fe.dispose(),b.dispose(),X.dispose(),ke.dispose(),B.dispose(),ee.dispose(),me.dispose(),me.removeEventListener("sessionstart",_0),me.removeEventListener("sessionend",v0),Wi.stop()};function Ie(T){T.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),L=!0}function xe(){console.log("THREE.WebGLRenderer: Context Restored."),L=!1;const T=de.autoReset,z=Le.enabled,Q=Le.autoUpdate,te=Le.needsUpdate,V=Le.type;Te(),de.autoReset=T,Le.enabled=z,Le.autoUpdate=Q,Le.needsUpdate=te,Le.type=V}function he(T){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",T.statusMessage)}function De(T){const z=T.target;z.removeEventListener("dispose",De),$e(z)}function $e(T){dt(T),oe.remove(T)}function dt(T){const z=oe.get(T).programs;z!==void 0&&(z.forEach(function(Q){ee.releaseProgram(Q)}),T.isShaderMaterial&&ee.releaseShaderCache(T))}this.renderBufferDirect=function(T,z,Q,te,V,Se){z===null&&(z=Ne);const Ae=V.isMesh&&V.matrixWorld.determinant()<0,Ue=Cp(T,z,Q,te,V);Y.setMaterial(te,Ae);let Re=Q.index,Ge=1;if(te.wireframe===!0){if(Re=F.getWireframeAttribute(Q),Re===void 0)return;Ge=2}const We=Q.drawRange,Fe=Q.attributes.position;let Qe=We.start*Ge,lt=(We.start+We.count)*Ge;Se!==null&&(Qe=Math.max(Qe,Se.start*Ge),lt=Math.min(lt,(Se.start+Se.count)*Ge)),Re!==null?(Qe=Math.max(Qe,0),lt=Math.min(lt,Re.count)):Fe!=null&&(Qe=Math.max(Qe,0),lt=Math.min(lt,Fe.count));const Et=lt-Qe;if(Et<0||Et===1/0)return;ke.setup(V,te,Ue,Q,Re);let pt,ft=Be;if(Re!==null&&(pt=x.get(Re),ft=Pe,ft.setIndex(pt)),V.isMesh)te.wireframe===!0?(Y.setLineWidth(te.wireframeLinewidth*C()),ft.setMode(v.LINES)):ft.setMode(v.TRIANGLES);else if(V.isLine){let He=te.linewidth;He===void 0&&(He=1),Y.setLineWidth(He*C()),V.isLineSegments?ft.setMode(v.LINES):V.isLineLoop?ft.setMode(v.LINE_LOOP):ft.setMode(v.LINE_STRIP)}else V.isPoints?ft.setMode(v.POINTS):V.isSprite&&ft.setMode(v.TRIANGLES);if(V.isBatchedMesh)if(V._multiDrawInstances!==null)$r("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),ft.renderMultiDrawInstances(V._multiDrawStarts,V._multiDrawCounts,V._multiDrawCount,V._multiDrawInstances);else if(ne.get("WEBGL_multi_draw"))ft.renderMultiDraw(V._multiDrawStarts,V._multiDrawCounts,V._multiDrawCount);else{const He=V._multiDrawStarts,xt=V._multiDrawCounts,nt=V._multiDrawCount,Qt=Re?x.get(Re).bytesPerElement:1,Mr=oe.get(te).currentProgram.getUniforms();for(let en=0;en<nt;en++)Mr.setValue(v,"_gl_DrawID",en),ft.render(He[en]/Qt,xt[en])}else if(V.isInstancedMesh)ft.renderInstances(Qe,Et,V.count);else if(Q.isInstancedBufferGeometry){const He=Q._maxInstanceCount!==void 0?Q._maxInstanceCount:1/0,xt=Math.min(Q.instanceCount,He);ft.renderInstances(Qe,Et,xt)}else ft.render(Qe,Et)};function at(T,z,Q){T.transparent===!0&&T.side===ei&&T.forceSinglePass===!1?(T.side=Kt,T.needsUpdate=!0,So(T,z,Q),T.side=Ui,T.needsUpdate=!0,So(T,z,Q),T.side=ei):So(T,z,Q)}this.compile=function(T,z,Q=null){Q===null&&(Q=T),p=ve.get(Q),p.init(z),S.push(p),Q.traverseVisible(function(V){V.isLight&&V.layers.test(z.layers)&&(p.pushLight(V),V.castShadow&&p.pushShadow(V))}),T!==Q&&T.traverseVisible(function(V){V.isLight&&V.layers.test(z.layers)&&(p.pushLight(V),V.castShadow&&p.pushShadow(V))}),p.setupLights();const te=new Set;return T.traverse(function(V){if(!(V.isMesh||V.isPoints||V.isLine||V.isSprite))return;const Se=V.material;if(Se)if(Array.isArray(Se))for(let Ae=0;Ae<Se.length;Ae++){const Ue=Se[Ae];at(Ue,Q,V),te.add(Ue)}else at(Se,Q,V),te.add(Se)}),p=S.pop(),te},this.compileAsync=function(T,z,Q=null){const te=this.compile(T,z,Q);return new Promise(V=>{function Se(){if(te.forEach(function(Ae){oe.get(Ae).currentProgram.isReady()&&te.delete(Ae)}),te.size===0){V(T);return}setTimeout(Se,10)}ne.get("KHR_parallel_shader_compile")!==null?Se():setTimeout(Se,10)})};let _n=null;function Wn(T){_n&&_n(T)}function _0(){Wi.stop()}function v0(){Wi.start()}const Wi=new D2;Wi.setAnimationLoop(Wn),typeof self<"u"&&Wi.setContext(self),this.setAnimationLoop=function(T){_n=T,me.setAnimationLoop(T),T===null?Wi.stop():Wi.start()},me.addEventListener("sessionstart",_0),me.addEventListener("sessionend",v0),this.render=function(T,z){if(z!==void 0&&z.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(L===!0)return;if(T.matrixWorldAutoUpdate===!0&&T.updateMatrixWorld(),z.parent===null&&z.matrixWorldAutoUpdate===!0&&z.updateMatrixWorld(),me.enabled===!0&&me.isPresenting===!0&&(me.cameraAutoUpdate===!0&&me.updateCamera(z),z=me.getCamera()),T.isScene===!0&&T.onBeforeRender(M,T,z,I),p=ve.get(T,S.length),p.init(z),S.push(p),re.multiplyMatrices(z.projectionMatrix,z.matrixWorldInverse),ie.setFromProjectionMatrix(re),J=this.localClippingEnabled,_e=be.init(this.clippingPlanes,J),m=Me.get(T,E.length),m.init(),E.push(m),me.enabled===!0&&me.isPresenting===!0){const Se=M.xr.getDepthSensingMesh();Se!==null&&il(Se,z,-1/0,M.sortObjects)}il(T,z,0,M.sortObjects),m.finish(),M.sortObjects===!0&&m.sort(se,K),ze=me.enabled===!1||me.isPresenting===!1||me.hasDepthSensing()===!1,ze&&pe.addToRenderList(m,T),this.info.render.frame++,_e===!0&&be.beginShadows();const Q=p.state.shadowsArray;Le.render(Q,T,z),_e===!0&&be.endShadows(),this.info.autoReset===!0&&this.info.reset();const te=m.opaque,V=m.transmissive;if(p.setupLights(),z.isArrayCamera){const Se=z.cameras;if(V.length>0)for(let Ae=0,Ue=Se.length;Ae<Ue;Ae++){const Re=Se[Ae];S0(te,V,T,Re)}ze&&pe.render(T);for(let Ae=0,Ue=Se.length;Ae<Ue;Ae++){const Re=Se[Ae];x0(m,T,Re,Re.viewport)}}else V.length>0&&S0(te,V,T,z),ze&&pe.render(T),x0(m,T,z);I!==null&&R===0&&(ce.updateMultisampleRenderTarget(I),ce.updateRenderTargetMipmap(I)),T.isScene===!0&&T.onAfterRender(M,T,z),ke.resetDefaultState(),A=-1,y=null,S.pop(),S.length>0?(p=S[S.length-1],_e===!0&&be.setGlobalState(M.clippingPlanes,p.state.camera)):p=null,E.pop(),E.length>0?m=E[E.length-1]:m=null};function il(T,z,Q,te){if(T.visible===!1)return;if(T.layers.test(z.layers)){if(T.isGroup)Q=T.renderOrder;else if(T.isLOD)T.autoUpdate===!0&&T.update(z);else if(T.isLight)p.pushLight(T),T.castShadow&&p.pushShadow(T);else if(T.isSprite){if(!T.frustumCulled||ie.intersectsSprite(T)){te&&le.setFromMatrixPosition(T.matrixWorld).applyMatrix4(re);const Ae=X.update(T),Ue=T.material;Ue.visible&&m.push(T,Ae,Ue,Q,le.z,null)}}else if((T.isMesh||T.isLine||T.isPoints)&&(!T.frustumCulled||ie.intersectsObject(T))){const Ae=X.update(T),Ue=T.material;if(te&&(T.boundingSphere!==void 0?(T.boundingSphere===null&&T.computeBoundingSphere(),le.copy(T.boundingSphere.center)):(Ae.boundingSphere===null&&Ae.computeBoundingSphere(),le.copy(Ae.boundingSphere.center)),le.applyMatrix4(T.matrixWorld).applyMatrix4(re)),Array.isArray(Ue)){const Re=Ae.groups;for(let Ge=0,We=Re.length;Ge<We;Ge++){const Fe=Re[Ge],Qe=Ue[Fe.materialIndex];Qe&&Qe.visible&&m.push(T,Ae,Qe,Q,le.z,Fe)}}else Ue.visible&&m.push(T,Ae,Ue,Q,le.z,null)}}const Se=T.children;for(let Ae=0,Ue=Se.length;Ae<Ue;Ae++)il(Se[Ae],z,Q,te)}function x0(T,z,Q,te){const V=T.opaque,Se=T.transmissive,Ae=T.transparent;p.setupLightsView(Q),_e===!0&&be.setGlobalState(M.clippingPlanes,Q),te&&Y.viewport(w.copy(te)),V.length>0&&xo(V,z,Q),Se.length>0&&xo(Se,z,Q),Ae.length>0&&xo(Ae,z,Q),Y.buffers.depth.setTest(!0),Y.buffers.depth.setMask(!0),Y.buffers.color.setMask(!0),Y.setPolygonOffset(!1)}function S0(T,z,Q,te){if((Q.isScene===!0?Q.overrideMaterial:null)!==null)return;p.state.transmissionRenderTarget[te.id]===void 0&&(p.state.transmissionRenderTarget[te.id]=new pr(1,1,{generateMipmaps:!0,type:ne.has("EXT_color_buffer_half_float")||ne.has("EXT_color_buffer_float")?ro:ci,minFilter:lr,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:rt.workingColorSpace}));const Se=p.state.transmissionRenderTarget[te.id],Ae=te.viewport||w;Se.setSize(Ae.z*M.transmissionResolutionScale,Ae.w*M.transmissionResolutionScale);const Ue=M.getRenderTarget(),Re=M.getActiveCubeFace(),Ge=M.getActiveMipmapLevel();M.setRenderTarget(Se),M.getClearColor(G),W=M.getClearAlpha(),W<1&&M.setClearColor(16777215,.5),M.clear(),ze&&pe.render(Q);const We=M.toneMapping;M.toneMapping=Li;const Fe=te.viewport;if(te.viewport!==void 0&&(te.viewport=void 0),p.setupLightsView(te),_e===!0&&be.setGlobalState(M.clippingPlanes,te),xo(T,Q,te),ce.updateMultisampleRenderTarget(Se),ce.updateRenderTargetMipmap(Se),ne.has("WEBGL_multisampled_render_to_texture")===!1){let Qe=!1;for(let lt=0,Et=z.length;lt<Et;lt++){const pt=z[lt],ft=pt.object,He=pt.geometry,xt=pt.material,nt=pt.group;if(xt.side===ei&&ft.layers.test(te.layers)){const Qt=xt.side;xt.side=Kt,xt.needsUpdate=!0,M0(ft,Q,te,He,xt,nt),xt.side=Qt,xt.needsUpdate=!0,Qe=!0}}Qe===!0&&(ce.updateMultisampleRenderTarget(Se),ce.updateRenderTargetMipmap(Se))}M.setRenderTarget(Ue,Re,Ge),M.setClearColor(G,W),Fe!==void 0&&(te.viewport=Fe),M.toneMapping=We}function xo(T,z,Q){const te=z.isScene===!0?z.overrideMaterial:null;for(let V=0,Se=T.length;V<Se;V++){const Ae=T[V],Ue=Ae.object,Re=Ae.geometry,Ge=Ae.group;let We=Ae.material;We.allowOverride===!0&&te!==null&&(We=te),Ue.layers.test(Q.layers)&&M0(Ue,z,Q,Re,We,Ge)}}function M0(T,z,Q,te,V,Se){T.onBeforeRender(M,z,Q,te,V,Se),T.modelViewMatrix.multiplyMatrices(Q.matrixWorldInverse,T.matrixWorld),T.normalMatrix.getNormalMatrix(T.modelViewMatrix),V.onBeforeRender(M,z,Q,te,T,Se),V.transparent===!0&&V.side===ei&&V.forceSinglePass===!1?(V.side=Kt,V.needsUpdate=!0,M.renderBufferDirect(Q,z,te,V,T,Se),V.side=Ui,V.needsUpdate=!0,M.renderBufferDirect(Q,z,te,V,T,Se),V.side=ei):M.renderBufferDirect(Q,z,te,V,T,Se),T.onAfterRender(M,z,Q,te,V,Se)}function So(T,z,Q){z.isScene!==!0&&(z=Ne);const te=oe.get(T),V=p.state.lights,Se=p.state.shadowsArray,Ae=V.state.version,Ue=ee.getParameters(T,V.state,Se,z,Q),Re=ee.getProgramCacheKey(Ue);let Ge=te.programs;te.environment=T.isMeshStandardMaterial?z.environment:null,te.fog=z.fog,te.envMap=(T.isMeshStandardMaterial?b:fe).get(T.envMap||te.environment),te.envMapRotation=te.environment!==null&&T.envMap===null?z.environmentRotation:T.envMapRotation,Ge===void 0&&(T.addEventListener("dispose",De),Ge=new Map,te.programs=Ge);let We=Ge.get(Re);if(We!==void 0){if(te.currentProgram===We&&te.lightsStateVersion===Ae)return E0(T,Ue),We}else Ue.uniforms=ee.getUniforms(T),T.onBeforeCompile(Ue,M),We=ee.acquireProgram(Ue,Re),Ge.set(Re,We),te.uniforms=Ue.uniforms;const Fe=te.uniforms;return(!T.isShaderMaterial&&!T.isRawShaderMaterial||T.clipping===!0)&&(Fe.clippingPlanes=be.uniform),E0(T,Ue),te.needsLights=Ap(T),te.lightsStateVersion=Ae,te.needsLights&&(Fe.ambientLightColor.value=V.state.ambient,Fe.lightProbe.value=V.state.probe,Fe.directionalLights.value=V.state.directional,Fe.directionalLightShadows.value=V.state.directionalShadow,Fe.spotLights.value=V.state.spot,Fe.spotLightShadows.value=V.state.spotShadow,Fe.rectAreaLights.value=V.state.rectArea,Fe.ltc_1.value=V.state.rectAreaLTC1,Fe.ltc_2.value=V.state.rectAreaLTC2,Fe.pointLights.value=V.state.point,Fe.pointLightShadows.value=V.state.pointShadow,Fe.hemisphereLights.value=V.state.hemi,Fe.directionalShadowMap.value=V.state.directionalShadowMap,Fe.directionalShadowMatrix.value=V.state.directionalShadowMatrix,Fe.spotShadowMap.value=V.state.spotShadowMap,Fe.spotLightMatrix.value=V.state.spotLightMatrix,Fe.spotLightMap.value=V.state.spotLightMap,Fe.pointShadowMap.value=V.state.pointShadowMap,Fe.pointShadowMatrix.value=V.state.pointShadowMatrix),te.currentProgram=We,te.uniformsList=null,We}function y0(T){if(T.uniformsList===null){const z=T.currentProgram.getUniforms();T.uniformsList=ua.seqWithValue(z.seq,T.uniforms)}return T.uniformsList}function E0(T,z){const Q=oe.get(T);Q.outputColorSpace=z.outputColorSpace,Q.batching=z.batching,Q.batchingColor=z.batchingColor,Q.instancing=z.instancing,Q.instancingColor=z.instancingColor,Q.instancingMorph=z.instancingMorph,Q.skinning=z.skinning,Q.morphTargets=z.morphTargets,Q.morphNormals=z.morphNormals,Q.morphColors=z.morphColors,Q.morphTargetsCount=z.morphTargetsCount,Q.numClippingPlanes=z.numClippingPlanes,Q.numIntersection=z.numClipIntersection,Q.vertexAlphas=z.vertexAlphas,Q.vertexTangents=z.vertexTangents,Q.toneMapping=z.toneMapping}function Cp(T,z,Q,te,V){z.isScene!==!0&&(z=Ne),ce.resetTextureUnits();const Se=z.fog,Ae=te.isMeshStandardMaterial?z.environment:null,Ue=I===null?M.outputColorSpace:I.isXRRenderTarget===!0?I.texture.colorSpace:rs,Re=(te.isMeshStandardMaterial?b:fe).get(te.envMap||Ae),Ge=te.vertexColors===!0&&!!Q.attributes.color&&Q.attributes.color.itemSize===4,We=!!Q.attributes.tangent&&(!!te.normalMap||te.anisotropy>0),Fe=!!Q.morphAttributes.position,Qe=!!Q.morphAttributes.normal,lt=!!Q.morphAttributes.color;let Et=Li;te.toneMapped&&(I===null||I.isXRRenderTarget===!0)&&(Et=M.toneMapping);const pt=Q.morphAttributes.position||Q.morphAttributes.normal||Q.morphAttributes.color,ft=pt!==void 0?pt.length:0,He=oe.get(te),xt=p.state.lights;if(_e===!0&&(J===!0||T!==y)){const Ot=T===y&&te.id===A;be.setState(te,T,Ot)}let nt=!1;te.version===He.__version?(He.needsLights&&He.lightsStateVersion!==xt.state.version||He.outputColorSpace!==Ue||V.isBatchedMesh&&He.batching===!1||!V.isBatchedMesh&&He.batching===!0||V.isBatchedMesh&&He.batchingColor===!0&&V.colorTexture===null||V.isBatchedMesh&&He.batchingColor===!1&&V.colorTexture!==null||V.isInstancedMesh&&He.instancing===!1||!V.isInstancedMesh&&He.instancing===!0||V.isSkinnedMesh&&He.skinning===!1||!V.isSkinnedMesh&&He.skinning===!0||V.isInstancedMesh&&He.instancingColor===!0&&V.instanceColor===null||V.isInstancedMesh&&He.instancingColor===!1&&V.instanceColor!==null||V.isInstancedMesh&&He.instancingMorph===!0&&V.morphTexture===null||V.isInstancedMesh&&He.instancingMorph===!1&&V.morphTexture!==null||He.envMap!==Re||te.fog===!0&&He.fog!==Se||He.numClippingPlanes!==void 0&&(He.numClippingPlanes!==be.numPlanes||He.numIntersection!==be.numIntersection)||He.vertexAlphas!==Ge||He.vertexTangents!==We||He.morphTargets!==Fe||He.morphNormals!==Qe||He.morphColors!==lt||He.toneMapping!==Et||He.morphTargetsCount!==ft)&&(nt=!0):(nt=!0,He.__version=te.version);let Qt=He.currentProgram;nt===!0&&(Qt=So(te,z,V));let Mr=!1,en=!1,ps=!1;const mt=Qt.getUniforms(),cn=He.uniforms;if(Y.useProgram(Qt.program)&&(Mr=!0,en=!0,ps=!0),te.id!==A&&(A=te.id,en=!0),Mr||y!==T){Y.buffers.depth.getReversed()?(N.copy(T.projectionMatrix),iv(N),rv(N),mt.setValue(v,"projectionMatrix",N)):mt.setValue(v,"projectionMatrix",T.projectionMatrix),mt.setValue(v,"viewMatrix",T.matrixWorldInverse);const Wt=mt.map.cameraPosition;Wt!==void 0&&Wt.setValue(v,ae.setFromMatrixPosition(T.matrixWorld)),j.logarithmicDepthBuffer&&mt.setValue(v,"logDepthBufFC",2/(Math.log(T.far+1)/Math.LN2)),(te.isMeshPhongMaterial||te.isMeshToonMaterial||te.isMeshLambertMaterial||te.isMeshBasicMaterial||te.isMeshStandardMaterial||te.isShaderMaterial)&&mt.setValue(v,"isOrthographic",T.isOrthographicCamera===!0),y!==T&&(y=T,en=!0,ps=!0)}if(V.isSkinnedMesh){mt.setOptional(v,V,"bindMatrix"),mt.setOptional(v,V,"bindMatrixInverse");const Ot=V.skeleton;Ot&&(Ot.boneTexture===null&&Ot.computeBoneTexture(),mt.setValue(v,"boneTexture",Ot.boneTexture,ce))}V.isBatchedMesh&&(mt.setOptional(v,V,"batchingTexture"),mt.setValue(v,"batchingTexture",V._matricesTexture,ce),mt.setOptional(v,V,"batchingIdTexture"),mt.setValue(v,"batchingIdTexture",V._indirectTexture,ce),mt.setOptional(v,V,"batchingColorTexture"),V._colorsTexture!==null&&mt.setValue(v,"batchingColorTexture",V._colorsTexture,ce));const un=Q.morphAttributes;if((un.position!==void 0||un.normal!==void 0||un.color!==void 0)&&we.update(V,Q,Qt),(en||He.receiveShadow!==V.receiveShadow)&&(He.receiveShadow=V.receiveShadow,mt.setValue(v,"receiveShadow",V.receiveShadow)),te.isMeshGouraudMaterial&&te.envMap!==null&&(cn.envMap.value=Re,cn.flipEnvMap.value=Re.isCubeTexture&&Re.isRenderTargetTexture===!1?-1:1),te.isMeshStandardMaterial&&te.envMap===null&&z.environment!==null&&(cn.envMapIntensity.value=z.environmentIntensity),en&&(mt.setValue(v,"toneMappingExposure",M.toneMappingExposure),He.needsLights&&Tp(cn,ps),Se&&te.fog===!0&&Z.refreshFogUniforms(cn,Se),Z.refreshMaterialUniforms(cn,te,O,q,p.state.transmissionRenderTarget[T.id]),ua.upload(v,y0(He),cn,ce)),te.isShaderMaterial&&te.uniformsNeedUpdate===!0&&(ua.upload(v,y0(He),cn,ce),te.uniformsNeedUpdate=!1),te.isSpriteMaterial&&mt.setValue(v,"center",V.center),mt.setValue(v,"modelViewMatrix",V.modelViewMatrix),mt.setValue(v,"normalMatrix",V.normalMatrix),mt.setValue(v,"modelMatrix",V.matrixWorld),te.isShaderMaterial||te.isRawShaderMaterial){const Ot=te.uniformsGroups;for(let Wt=0,rl=Ot.length;Wt<rl;Wt++){const Xi=Ot[Wt];B.update(Xi,Qt),B.bind(Xi,Qt)}}return Qt}function Tp(T,z){T.ambientLightColor.needsUpdate=z,T.lightProbe.needsUpdate=z,T.directionalLights.needsUpdate=z,T.directionalLightShadows.needsUpdate=z,T.pointLights.needsUpdate=z,T.pointLightShadows.needsUpdate=z,T.spotLights.needsUpdate=z,T.spotLightShadows.needsUpdate=z,T.rectAreaLights.needsUpdate=z,T.hemisphereLights.needsUpdate=z}function Ap(T){return T.isMeshLambertMaterial||T.isMeshToonMaterial||T.isMeshPhongMaterial||T.isMeshStandardMaterial||T.isShadowMaterial||T.isShaderMaterial&&T.lights===!0}this.getActiveCubeFace=function(){return P},this.getActiveMipmapLevel=function(){return R},this.getRenderTarget=function(){return I},this.setRenderTargetTextures=function(T,z,Q){const te=oe.get(T);te.__autoAllocateDepthBuffer=T.resolveDepthBuffer===!1,te.__autoAllocateDepthBuffer===!1&&(te.__useRenderToTexture=!1),oe.get(T.texture).__webglTexture=z,oe.get(T.depthTexture).__webglTexture=te.__autoAllocateDepthBuffer?void 0:Q,te.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(T,z){const Q=oe.get(T);Q.__webglFramebuffer=z,Q.__useDefaultFramebuffer=z===void 0};const bp=v.createFramebuffer();this.setRenderTarget=function(T,z=0,Q=0){I=T,P=z,R=Q;let te=!0,V=null,Se=!1,Ae=!1;if(T){const Re=oe.get(T);if(Re.__useDefaultFramebuffer!==void 0)Y.bindFramebuffer(v.FRAMEBUFFER,null),te=!1;else if(Re.__webglFramebuffer===void 0)ce.setupRenderTarget(T);else if(Re.__hasExternalTextures)ce.rebindTextures(T,oe.get(T.texture).__webglTexture,oe.get(T.depthTexture).__webglTexture);else if(T.depthBuffer){const Fe=T.depthTexture;if(Re.__boundDepthTexture!==Fe){if(Fe!==null&&oe.has(Fe)&&(T.width!==Fe.image.width||T.height!==Fe.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");ce.setupDepthRenderbuffer(T)}}const Ge=T.texture;(Ge.isData3DTexture||Ge.isDataArrayTexture||Ge.isCompressedArrayTexture)&&(Ae=!0);const We=oe.get(T).__webglFramebuffer;T.isWebGLCubeRenderTarget?(Array.isArray(We[z])?V=We[z][Q]:V=We[z],Se=!0):T.samples>0&&ce.useMultisampledRTT(T)===!1?V=oe.get(T).__webglMultisampledFramebuffer:Array.isArray(We)?V=We[Q]:V=We,w.copy(T.viewport),U.copy(T.scissor),D=T.scissorTest}else w.copy(ue).multiplyScalar(O).floor(),U.copy(Ee).multiplyScalar(O).floor(),D=Oe;if(Q!==0&&(V=bp),Y.bindFramebuffer(v.FRAMEBUFFER,V)&&te&&Y.drawBuffers(T,V),Y.viewport(w),Y.scissor(U),Y.setScissorTest(D),Se){const Re=oe.get(T.texture);v.framebufferTexture2D(v.FRAMEBUFFER,v.COLOR_ATTACHMENT0,v.TEXTURE_CUBE_MAP_POSITIVE_X+z,Re.__webglTexture,Q)}else if(Ae){const Re=oe.get(T.texture),Ge=z;v.framebufferTextureLayer(v.FRAMEBUFFER,v.COLOR_ATTACHMENT0,Re.__webglTexture,Q,Ge)}else if(T!==null&&Q!==0){const Re=oe.get(T.texture);v.framebufferTexture2D(v.FRAMEBUFFER,v.COLOR_ATTACHMENT0,v.TEXTURE_2D,Re.__webglTexture,Q)}A=-1},this.readRenderTargetPixels=function(T,z,Q,te,V,Se,Ae,Ue=0){if(!(T&&T.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Re=oe.get(T).__webglFramebuffer;if(T.isWebGLCubeRenderTarget&&Ae!==void 0&&(Re=Re[Ae]),Re){Y.bindFramebuffer(v.FRAMEBUFFER,Re);try{const Ge=T.textures[Ue],We=Ge.format,Fe=Ge.type;if(!j.textureFormatReadable(We)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!j.textureTypeReadable(Fe)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}z>=0&&z<=T.width-te&&Q>=0&&Q<=T.height-V&&(T.textures.length>1&&v.readBuffer(v.COLOR_ATTACHMENT0+Ue),v.readPixels(z,Q,te,V,ye.convert(We),ye.convert(Fe),Se))}finally{const Ge=I!==null?oe.get(I).__webglFramebuffer:null;Y.bindFramebuffer(v.FRAMEBUFFER,Ge)}}},this.readRenderTargetPixelsAsync=async function(T,z,Q,te,V,Se,Ae,Ue=0){if(!(T&&T.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Re=oe.get(T).__webglFramebuffer;if(T.isWebGLCubeRenderTarget&&Ae!==void 0&&(Re=Re[Ae]),Re)if(z>=0&&z<=T.width-te&&Q>=0&&Q<=T.height-V){Y.bindFramebuffer(v.FRAMEBUFFER,Re);const Ge=T.textures[Ue],We=Ge.format,Fe=Ge.type;if(!j.textureFormatReadable(We))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!j.textureTypeReadable(Fe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Qe=v.createBuffer();v.bindBuffer(v.PIXEL_PACK_BUFFER,Qe),v.bufferData(v.PIXEL_PACK_BUFFER,Se.byteLength,v.STREAM_READ),T.textures.length>1&&v.readBuffer(v.COLOR_ATTACHMENT0+Ue),v.readPixels(z,Q,te,V,ye.convert(We),ye.convert(Fe),0);const lt=I!==null?oe.get(I).__webglFramebuffer:null;Y.bindFramebuffer(v.FRAMEBUFFER,lt);const Et=v.fenceSync(v.SYNC_GPU_COMMANDS_COMPLETE,0);return v.flush(),await nv(v,Et,4),v.bindBuffer(v.PIXEL_PACK_BUFFER,Qe),v.getBufferSubData(v.PIXEL_PACK_BUFFER,0,Se),v.deleteBuffer(Qe),v.deleteSync(Et),Se}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(T,z=null,Q=0){const te=Math.pow(2,-Q),V=Math.floor(T.image.width*te),Se=Math.floor(T.image.height*te),Ae=z!==null?z.x:0,Ue=z!==null?z.y:0;ce.setTexture2D(T,0),v.copyTexSubImage2D(v.TEXTURE_2D,Q,0,0,Ae,Ue,V,Se),Y.unbindTexture()};const wp=v.createFramebuffer(),Rp=v.createFramebuffer();this.copyTextureToTexture=function(T,z,Q=null,te=null,V=0,Se=null){Se===null&&(V!==0?($r("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),Se=V,V=0):Se=0);let Ae,Ue,Re,Ge,We,Fe,Qe,lt,Et;const pt=T.isCompressedTexture?T.mipmaps[Se]:T.image;if(Q!==null)Ae=Q.max.x-Q.min.x,Ue=Q.max.y-Q.min.y,Re=Q.isBox3?Q.max.z-Q.min.z:1,Ge=Q.min.x,We=Q.min.y,Fe=Q.isBox3?Q.min.z:0;else{const un=Math.pow(2,-V);Ae=Math.floor(pt.width*un),Ue=Math.floor(pt.height*un),T.isDataArrayTexture?Re=pt.depth:T.isData3DTexture?Re=Math.floor(pt.depth*un):Re=1,Ge=0,We=0,Fe=0}te!==null?(Qe=te.x,lt=te.y,Et=te.z):(Qe=0,lt=0,Et=0);const ft=ye.convert(z.format),He=ye.convert(z.type);let xt;z.isData3DTexture?(ce.setTexture3D(z,0),xt=v.TEXTURE_3D):z.isDataArrayTexture||z.isCompressedArrayTexture?(ce.setTexture2DArray(z,0),xt=v.TEXTURE_2D_ARRAY):(ce.setTexture2D(z,0),xt=v.TEXTURE_2D),v.pixelStorei(v.UNPACK_FLIP_Y_WEBGL,z.flipY),v.pixelStorei(v.UNPACK_PREMULTIPLY_ALPHA_WEBGL,z.premultiplyAlpha),v.pixelStorei(v.UNPACK_ALIGNMENT,z.unpackAlignment);const nt=v.getParameter(v.UNPACK_ROW_LENGTH),Qt=v.getParameter(v.UNPACK_IMAGE_HEIGHT),Mr=v.getParameter(v.UNPACK_SKIP_PIXELS),en=v.getParameter(v.UNPACK_SKIP_ROWS),ps=v.getParameter(v.UNPACK_SKIP_IMAGES);v.pixelStorei(v.UNPACK_ROW_LENGTH,pt.width),v.pixelStorei(v.UNPACK_IMAGE_HEIGHT,pt.height),v.pixelStorei(v.UNPACK_SKIP_PIXELS,Ge),v.pixelStorei(v.UNPACK_SKIP_ROWS,We),v.pixelStorei(v.UNPACK_SKIP_IMAGES,Fe);const mt=T.isDataArrayTexture||T.isData3DTexture,cn=z.isDataArrayTexture||z.isData3DTexture;if(T.isDepthTexture){const un=oe.get(T),Ot=oe.get(z),Wt=oe.get(un.__renderTarget),rl=oe.get(Ot.__renderTarget);Y.bindFramebuffer(v.READ_FRAMEBUFFER,Wt.__webglFramebuffer),Y.bindFramebuffer(v.DRAW_FRAMEBUFFER,rl.__webglFramebuffer);for(let Xi=0;Xi<Re;Xi++)mt&&(v.framebufferTextureLayer(v.READ_FRAMEBUFFER,v.COLOR_ATTACHMENT0,oe.get(T).__webglTexture,V,Fe+Xi),v.framebufferTextureLayer(v.DRAW_FRAMEBUFFER,v.COLOR_ATTACHMENT0,oe.get(z).__webglTexture,Se,Et+Xi)),v.blitFramebuffer(Ge,We,Ae,Ue,Qe,lt,Ae,Ue,v.DEPTH_BUFFER_BIT,v.NEAREST);Y.bindFramebuffer(v.READ_FRAMEBUFFER,null),Y.bindFramebuffer(v.DRAW_FRAMEBUFFER,null)}else if(V!==0||T.isRenderTargetTexture||oe.has(T)){const un=oe.get(T),Ot=oe.get(z);Y.bindFramebuffer(v.READ_FRAMEBUFFER,wp),Y.bindFramebuffer(v.DRAW_FRAMEBUFFER,Rp);for(let Wt=0;Wt<Re;Wt++)mt?v.framebufferTextureLayer(v.READ_FRAMEBUFFER,v.COLOR_ATTACHMENT0,un.__webglTexture,V,Fe+Wt):v.framebufferTexture2D(v.READ_FRAMEBUFFER,v.COLOR_ATTACHMENT0,v.TEXTURE_2D,un.__webglTexture,V),cn?v.framebufferTextureLayer(v.DRAW_FRAMEBUFFER,v.COLOR_ATTACHMENT0,Ot.__webglTexture,Se,Et+Wt):v.framebufferTexture2D(v.DRAW_FRAMEBUFFER,v.COLOR_ATTACHMENT0,v.TEXTURE_2D,Ot.__webglTexture,Se),V!==0?v.blitFramebuffer(Ge,We,Ae,Ue,Qe,lt,Ae,Ue,v.COLOR_BUFFER_BIT,v.NEAREST):cn?v.copyTexSubImage3D(xt,Se,Qe,lt,Et+Wt,Ge,We,Ae,Ue):v.copyTexSubImage2D(xt,Se,Qe,lt,Ge,We,Ae,Ue);Y.bindFramebuffer(v.READ_FRAMEBUFFER,null),Y.bindFramebuffer(v.DRAW_FRAMEBUFFER,null)}else cn?T.isDataTexture||T.isData3DTexture?v.texSubImage3D(xt,Se,Qe,lt,Et,Ae,Ue,Re,ft,He,pt.data):z.isCompressedArrayTexture?v.compressedTexSubImage3D(xt,Se,Qe,lt,Et,Ae,Ue,Re,ft,pt.data):v.texSubImage3D(xt,Se,Qe,lt,Et,Ae,Ue,Re,ft,He,pt):T.isDataTexture?v.texSubImage2D(v.TEXTURE_2D,Se,Qe,lt,Ae,Ue,ft,He,pt.data):T.isCompressedTexture?v.compressedTexSubImage2D(v.TEXTURE_2D,Se,Qe,lt,pt.width,pt.height,ft,pt.data):v.texSubImage2D(v.TEXTURE_2D,Se,Qe,lt,Ae,Ue,ft,He,pt);v.pixelStorei(v.UNPACK_ROW_LENGTH,nt),v.pixelStorei(v.UNPACK_IMAGE_HEIGHT,Qt),v.pixelStorei(v.UNPACK_SKIP_PIXELS,Mr),v.pixelStorei(v.UNPACK_SKIP_ROWS,en),v.pixelStorei(v.UNPACK_SKIP_IMAGES,ps),Se===0&&z.generateMipmaps&&v.generateMipmap(xt),Y.unbindTexture()},this.copyTextureToTexture3D=function(T,z,Q=null,te=null,V=0){return $r('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(T,z,Q,te,V)},this.initRenderTarget=function(T){oe.get(T).__webglFramebuffer===void 0&&ce.setupRenderTarget(T)},this.initTexture=function(T){T.isCubeTexture?ce.setTextureCube(T,0):T.isData3DTexture?ce.setTexture3D(T,0):T.isDataArrayTexture||T.isCompressedArrayTexture?ce.setTexture2DArray(T,0):ce.setTexture2D(T,0),Y.unbindTexture()},this.resetState=function(){P=0,R=0,I=null,Y.reset(),ke.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return ni}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=rt._getDrawingBufferColorSpace(e),t.unpackColorSpace=rt._getUnpackColorSpace()}}const zM={ref:"heroSection"},VM=ge("div",{class:"glow"},null,-1),kM=ge("h2",null,"Hey! I’m Mateus Felipe",-1),GM=ge("h1",null,[ge("span",{class:"word"},"Web Developer"),ge("span",{class:"word"},"UI/UX Designer")],-1),WM={class:"socials"},XM=["src"],$M=["src"],qM={class:"actions"},YM={class:"contact"},ZM=ge("canvas",{id:"space-background"},null,-1),KM=5,jM={__name:"Hero",setup(n){let e=3e-4;const t=[];return vr(()=>{const i=document.getElementById("space-background"),r=new T2,s=new sn(75,window.innerWidth/window.innerHeight,.1,1e3);s.position.z=5;const o=new B2({canvas:i,alpha:!0});o.setSize(window.innerWidth,window.innerHeight),o.setPixelRatio(window.devicePixelRatio),window.addEventListener("resize",()=>{s.aspect=window.innerWidth/window.innerHeight,s.updateProjectionMatrix(),o.setSize(window.innerWidth,window.innerHeight)});const a=new ln,l=2e3,c=[];function u(){const U=document.createElement("canvas");U.width=64,U.height=64;const D=U.getContext("2d"),G=D.createLinearGradient(64/2,64/2,0,64/2,64/2,64/2);return G.addColorStop(0,"#f5f5f5"),G.addColorStop(1,"#adadad"),D.fillStyle=G,D.beginPath(),D.arc(64/2,64/2,64/2,0,Math.PI*4),D.fill(),new Nv(U)}for(let w=0;w<l;w++){const U=(Math.random()-.5)*100,D=(Math.random()-.5)*100,G=(Math.random()-.5)*100;c.push(U,D,G)}a.setAttribute("position",new Lt(c,3));const f=[];for(let w=0;w<l;w++)Math.random()<.1?f.push(.76,.15,.15):f.push(1,1,1);a.setAttribute("color",new Lt(f,3));const h=new w2({size:Math.random()*.05+.06,map:u(),transparent:!0,alphaTest:.01,blending:_c,depthWrite:!1,vertexColors:!0}),d=new Uv(a,h);r.add(d);let g=0,_=0;document.addEventListener("mousemove",w=>{g=(w.clientX-window.innerWidth/2)*5e-4,_=(w.clientY-window.innerHeight/2)*5e-4});let m=0;window.addEventListener("scroll",()=>{m=window.scrollY*7e-4});function p(w,U,D=1.5){const G=[];for(let W=0;W<=10;W++){const $=W/10,q=new H().copy(w).addScaledVector(U,-$*D);G.push(q)}return new L2(G)}function E(){const w=Math.random()*Math.PI*2,U=50+Math.random()*20,D=new H(Math.cos(w)*U,Math.random()*30-15,Math.sin(w)*U-50),G=new H(-Math.cos(w)*.6,(Math.random()-.5)*.3,1),W=new Zu(p(D,G),20,.02,8,!1),$=new $u({color:16777215,transparent:!0,opacity:.6}),q=new Tn(W,$);r.add(q),t.push({mesh:q,velocity:G,lifetime:0,material:$})}const S=()=>{requestAnimationFrame(S),d.rotation.y+=e,d.rotation.x+=e*.25,s.position.x+=(g-s.position.x)*.05,s.position.y+=(-_-s.position.y)*.05,s.position.z=5+m,Math.random()<.01&&t.length<KM&&E();for(let w=t.length-1;w>=0;w--){const U=t[w];U.mesh.position.add(U.velocity),U.lifetime+=1,U.lifetime>100&&(r.remove(U.mesh),t.splice(w,1))}o.render(r,s)};S();const M=document.getElementsByClassName("word"),L=[];let P=0;M[P].style.opacity=1;for(let w=0;w<M.length;w++)y(M[w]);function R(){const w=L[P],U=P==M.length-1?L[0]:L[P+1];for(let D=0;D<w.length;D++)I(w,D);for(let D=0;D<U.length;D++)U[D].className="letter behind",U[0].parentElement.style.opacity=1,A(U,D);P=P==L.length-1?0:P+1}function I(w,U){setTimeout(function(){w[U].className="letter out"},U*45)}function A(w,U){setTimeout(()=>{w[U].className="letter in"},340+U*45)}function y(w){const U=w.innerHTML;w.innerHTML="";const D=[];for(let G=0;G<U.length;G++){const W=document.createElement("span");W.className="letter",W.innerHTML=U.charAt(G),w.appendChild(W),D.push(W)}L.push(D)}R(),setInterval(R,3500)}),(i,r)=>(je(),st("main",zM,[VM,kM,GM,ge("div",WM,[ge("a",{onClick:r[0]||(r[0]=s=>it(rn)("https://github.com/mateusfcolla","_blank")),rel:"noopener noreferrer"},[ge("img",{src:it(Wd),alt:"My Github"},null,8,XM)]),ge("a",{onClick:r[1]||(r[1]=s=>it(rn)("https://dribbble.com/coall_fcm","_blank")),rel:"noopener noreferrer"},[ge("img",{src:it(Xd),alt:"My Dribbble"},null,8,$M)])]),ge("div",qM,[ge("div",{class:"button outline",onClick:r[2]||(r[2]=s=>it(rn)("#relevant-projects"))},"what I've been working on")]),ge("div",YM,[ge("a",{onClick:r[3]||(r[3]=s=>it(rn)("mailto:felipe.colla.m@gmail.com","_blank"))},"felipe.colla.m@gmail.com")]),ZM],512))}},JM="/assets/Engeled-Chg6Unmo.png",QM="/assets/Superpet-Cb3hFaoK.png",ey="/assets/Velope-CGmblxup.png",ty="/assets/Oli-DShSKzDR.png",ny={id:"relevant-projects"},iy=ge("h2",null,"Portfolio",-1),ry=["id","onMousemove"],sy=["src","alt"],oy={class:"project-content"},ay=["href"],ly={class:"project-title"},cy={class:"project-subtitle"},uy={__name:"Projects",setup(n){const e=[{title:"Oli",subtitle:"Website",background:ty,url:"http://oliapp.com.br/"},{title:"Engeled",subtitle:"Website",background:JM,url:"https://engeled.com.br/"},{title:"Superpet",subtitle:"Website",url:"https://superpetdelivery.com.br/",background:QM},{title:"Velope",subtitle:"Design",url:"https://velope.com.br/",background:ey}],t=Fn([]),i=(r,s)=>{const o=t.value[r],a=s.currentTarget.getBoundingClientRect(),l=s.clientX-a.left,c=s.clientY-a.top;if(o){const f=-(r/(e.length-1)*2-1)*20;o.style.transform=`translate(${l}px, ${c}px) translate(-80%, calc(-50% + ${f}%))`}};return vr(()=>{for(let r=0;r<e.length;r++){const s=t.value[r];s&&(s.style.transform="translate(-80%, -50%)")}}),(r,s)=>(je(),st("section",ny,[iy,(je(),st(ut,null,Yt(e,(o,a)=>ge("div",{class:"project",key:`project-${a}-${o.title}`,id:`project-${a}`,onMousemove:l=>i(a,l)},[ge("img",{class:"project-background",ref_for:!0,ref:l=>t.value[a]=l,src:o.background,alt:`Project background for ${o.title}`},null,8,sy),ge("div",oy,[ge("a",{class:"project-link",href:o.url,target:"_blank"},[ge("h3",ly,qt(o.title),1),ge("p",cy,qt(o.subtitle),1)],8,ay)])],40,ry)),64))]))}},fy={class:"logo-displayer"},hy=ge("h2",null,"Technology Stack",-1),dy={class:"logo-row"},py=ge("div",{class:"empty-logo"},null,-1),my=[py],gy=ge("div",{class:"empty-logo"},null,-1),_y=[gy],vy=["href","onMouseenter"],xy=["src","alt"],Sy=ge("div",{class:"empty-logo"},null,-1),My=[Sy],yy={class:"logo-row"},Ey=ge("div",{class:"empty-logo"},null,-1),Cy=[Ey],Ty=104,Ay=16,by={__name:"LogoDisplayer",setup(n){const e=Dg(),t=Fn(!1),i=Fn([]),r=Fn(null),s=Fn([]),o=()=>{Au(()=>{const l=document.querySelector(".logo-displayer");if(!l)return;const c=l.clientWidth-25.6*2,u=Ty+Ay*2,f=Math.max(1,Math.floor(c/u)),h=[];for(let d=0;d<i.value.length;d+=f)h.push(i.value.slice(d,d+f));s.value=h})},a=()=>e.sort(()=>.5-Math.random());return vr(()=>{i.value=a(),o(),window.addEventListener("resize",o);const l=new IntersectionObserver(([u])=>{u.isIntersecting&&(t.value=!0,l.disconnect())},{root:null,threshold:.3}),c=document.querySelector(".logo-displayer");c&&l.observe(c)}),Ha(()=>{window.removeEventListener("resize",groupLogos)}),(l,c)=>(je(),st("section",fy,[hy,ge("div",dy,[(je(),st(ut,null,Yt(20,u=>ge("a",{class:"logo-display empty",key:"empty-"+u},my)),64))]),(je(!0),st(ut,null,Yt(s.value,(u,f)=>(je(),st("div",{class:"logo-row",key:"row-"+f},[(je(),st(ut,null,Yt(10,h=>ge("a",{class:"logo-display empty",key:"empty-"+h},_y)),64)),(je(!0),st(ut,null,Yt(u,(h,d)=>(je(),st("a",{class:li(["logo-display",{animated:t.value}]),href:h==null?void 0:h.link,target:"_blank",key:(h==null?void 0:h.name)+d+f,style:Bs({boxShadow:r.value===(h==null?void 0:h.name)+d+f?`0px 0px 30px -10px ${h==null?void 0:h.color}`:"",borderColor:r.value===(h==null?void 0:h.name)+d+f?h==null?void 0:h.color:""}),onMouseenter:g=>r.value=(h==null?void 0:h.name)+d+f,onMouseleave:c[0]||(c[0]=g=>r.value=null)},[h!=null&&h.img?(je(),st("img",{key:0,src:h==null?void 0:h.img,alt:h==null?void 0:h.name,style:Bs({animationDelay:`${(f*s.value[0].length+d)*60}ms`})},null,12,xy)):ia("",!0)],46,vy))),128)),(je(),st(ut,null,Yt(10,h=>ge("a",{class:"logo-display empty",key:"empty-"+h},My)),64))]))),128)),ge("div",yy,[(je(),st(ut,null,Yt(20,u=>ge("a",{class:"logo-display empty",key:"empty-"+u},Cy)),64))])]))}},wy={id:"about"},Ry={class:"left"},Py=ge("h2",null,"A little about myself...",-1),Ly=ge("p",null,[Jr("I work and specialize in since 2018."),ge("span",null,qt(" ")+" web development and design "+qt(" ")),Jr("I’m passionate about creating inspiring interfaces and improving applications.")],-1),Iy=ge("div",{class:"right"},[ge("h2",null,"Languages"),ge("ul",null,[ge("li",null,"Fluent English"),ge("li",null,"Native Brazillian Portuguese"),ge("li",null,"Basic German")]),ge("div",{id:"threejs-container"})],-1),Dy={__name:"About",setup(n){let e,t,i,r,s,o;function a(S){if(!e||!i||!S)return;const M=S.offsetWidth,L=S.offsetHeight;e.setSize(M,L),i.aspect=M/L,i.updateProjectionMatrix()}let l=!1,c=0,u=!0,f=.003;const h=f;let d=0,g=!1;function _(S){l=!0,u=!1,c=S.clientX,d=0,g=!1}function m(S){if(!l)return;const M=S.clientX-c;c=S.clientX;const P=M*.01;r.rotation.y+=P,s.rotation.y+=P,d=P}function p(){l=!1,f=d,u=!0,g=!0}function E(){g&&(f+=(h-f)*.05,Math.abs(f-h)<1e-4&&(f=h,g=!1))}return vr(()=>{const S=document.getElementById("threejs-container");if(!S)return;t=new T2,i=new sn(60,S.offsetWidth/S.offsetHeight,.1,1e3),i.position.z=2.5,e=new B2({alpha:!0,antialias:!0}),e.setSize(S.offsetWidth,S.offsetHeight),e.setClearColor(0,0),S.appendChild(e.domElement);const M=new Yu(1.2,16,16),L=new Qv({color:16777215,transparent:!0,opacity:0});r=new Tn(M,L),t.add(r);const P=new jv(M);s=new Dv(P,new b2({color:3881787,linewidth:2})),t.add(s);function R(){o=requestAnimationFrame(R),u&&(r.rotation.y+=f,s.rotation.y+=f,E()),e.render(t,i)}R();const I=()=>a(S);window.addEventListener("resize",I);const A=e.domElement;A.addEventListener("pointerdown",_),window.addEventListener("pointermove",m),window.addEventListener("pointerup",p),a(S),Ha(()=>{window.removeEventListener("resize",I),o&&cancelAnimationFrame(o),e&&(e.dispose(),e.forceContextLoss(),e.domElement=null,e=null),t=null,i=null,r=null,s=null,A.removeEventListener("pointerdown",_),window.removeEventListener("pointermove",m),window.removeEventListener("pointerup",p)})}),(S,M)=>(je(),st(ut,null,[ge("section",wy,[ge("div",Ry,[Py,Ly,ge("div",{class:"button",onClick:M[0]||(M[0]=L=>it(rn)("mailto:felipe.colla.m@gmail.com","_blank"))},"contact me")]),Iy]),_t(by)],64))}};function Uy(n,e){for(var t=0;t<e.length;t++){var i=e[t];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(n,i.key,i)}}function Ny(n,e,t){return e&&Uy(n.prototype,e),Object.defineProperty(n,"prototype",{writable:!1}),n}/*!
 * Splide.js
 * Version  : 4.1.3
 * License  : MIT
 * Copyright: 2022 Naotoshi Fujita
 */var vh="(prefers-reduced-motion: reduce)",zr=1,Fy=2,os=3,fs=4,uo=5,fa=6,Aa=7,Oy={CREATED:zr,MOUNTED:Fy,IDLE:os,MOVING:fs,SCROLLING:uo,DRAGGING:fa,DESTROYED:Aa};function ui(n){n.length=0}function Vi(n,e,t){return Array.prototype.slice.call(n,e,t)}function ht(n){return n.bind.apply(n,[null].concat(Vi(arguments,1)))}var H2=setTimeout,ou=function(){};function xh(n){return requestAnimationFrame(n)}function $a(n,e){return typeof e===n}function Zs(n){return!Ju(n)&&$a("object",n)}var ju=Array.isArray,z2=ht($a,"function"),Fi=ht($a,"string"),fo=ht($a,"undefined");function Ju(n){return n===null}function V2(n){try{return n instanceof(n.ownerDocument.defaultView||window).HTMLElement}catch{return!1}}function ho(n){return ju(n)?n:[n]}function gn(n,e){ho(n).forEach(e)}function Qu(n,e){return n.indexOf(e)>-1}function ha(n,e){return n.push.apply(n,ho(e)),n}function ii(n,e,t){n&&gn(e,function(i){i&&n.classList[t?"add":"remove"](i)})}function Vn(n,e){ii(n,Fi(e)?e.split(" "):e,!0)}function po(n,e){gn(e,n.appendChild.bind(n))}function e0(n,e){gn(n,function(t){var i=(e||t).parentNode;i&&i.insertBefore(t,e)})}function Ks(n,e){return V2(n)&&(n.msMatchesSelector||n.matches).call(n,e)}function k2(n,e){var t=n?Vi(n.children):[];return e?t.filter(function(i){return Ks(i,e)}):t}function mo(n,e){return e?k2(n,e)[0]:n.firstElementChild}var js=Object.keys;function fr(n,e,t){return n&&(t?js(n).reverse():js(n)).forEach(function(i){i!=="__proto__"&&e(n[i],i)}),n}function Js(n){return Vi(arguments,1).forEach(function(e){fr(e,function(t,i){n[i]=e[i]})}),n}function Ai(n){return Vi(arguments,1).forEach(function(e){fr(e,function(t,i){ju(t)?n[i]=t.slice():Zs(t)?n[i]=Ai({},Zs(n[i])?n[i]:{},t):n[i]=t})}),n}function Sh(n,e){gn(e||js(n),function(t){delete n[t]})}function kn(n,e){gn(n,function(t){gn(e,function(i){t&&t.removeAttribute(i)})})}function Ze(n,e,t){Zs(e)?fr(e,function(i,r){Ze(n,r,i)}):gn(n,function(i){Ju(t)||t===""?kn(i,e):i.setAttribute(e,String(t))})}function Yr(n,e,t){var i=document.createElement(n);return e&&(Fi(e)?Vn(i,e):Ze(i,e)),t&&po(t,i),i}function yn(n,e,t){if(fo(t))return getComputedStyle(n)[e];Ju(t)||(n.style[e]=""+t)}function Qs(n,e){yn(n,"display",e)}function G2(n){n.setActive&&n.setActive()||n.focus({preventScroll:!0})}function An(n,e){return n.getAttribute(e)}function Mh(n,e){return n&&n.classList.contains(e)}function dn(n){return n.getBoundingClientRect()}function mr(n){gn(n,function(e){e&&e.parentNode&&e.parentNode.removeChild(e)})}function W2(n){return mo(new DOMParser().parseFromString(n,"text/html").body)}function Qn(n,e){n.preventDefault(),e&&(n.stopPropagation(),n.stopImmediatePropagation())}function X2(n,e){return n&&n.querySelector(e)}function t0(n,e){return e?Vi(n.querySelectorAll(e)):[]}function ri(n,e){ii(n,e,!1)}function au(n){return n.timeStamp}function er(n){return Fi(n)?n:n?n+"px":""}var go="splide",n0="data-"+go;function Fs(n,e){if(!n)throw new Error("["+go+"] "+(e||""))}var Oi=Math.min,ba=Math.max,wa=Math.floor,eo=Math.ceil,Zt=Math.abs;function $2(n,e,t){return Zt(n-e)<t}function da(n,e,t,i){var r=Oi(e,t),s=ba(e,t);return i?r<n&&n<s:r<=n&&n<=s}function Or(n,e,t){var i=Oi(e,t),r=ba(e,t);return Oi(ba(i,n),r)}function lu(n){return+(n>0)-+(n<0)}function cu(n,e){return gn(e,function(t){n=n.replace("%s",""+t)}),n}function i0(n){return n<10?"0"+n:""+n}var yh={};function By(n){return""+n+i0(yh[n]=(yh[n]||0)+1)}function q2(){var n=[];function e(o,a,l,c){r(o,a,function(u,f,h){var d="addEventListener"in u,g=d?u.removeEventListener.bind(u,f,l,c):u.removeListener.bind(u,l);d?u.addEventListener(f,l,c):u.addListener(l),n.push([u,f,h,l,g])})}function t(o,a,l){r(o,a,function(c,u,f){n=n.filter(function(h){return h[0]===c&&h[1]===u&&h[2]===f&&(!l||h[3]===l)?(h[4](),!1):!0})})}function i(o,a,l){var c,u=!0;return typeof CustomEvent=="function"?c=new CustomEvent(a,{bubbles:u,detail:l}):(c=document.createEvent("CustomEvent"),c.initCustomEvent(a,u,!1,l)),o.dispatchEvent(c),c}function r(o,a,l){gn(o,function(c){c&&gn(a,function(u){u.split(" ").forEach(function(f){var h=f.split(".");l(c,h[0],h[1])})})})}function s(){n.forEach(function(o){o[4]()}),ui(n)}return{bind:e,unbind:t,dispatch:i,destroy:s}}var ki="mounted",Eh="ready",fi="move",hs="moved",r0="click",Y2="active",Z2="inactive",K2="visible",j2="hidden",At="refresh",Gt="updated",as="resize",qa="resized",J2="drag",Q2="dragging",ep="dragged",Ya="scroll",Sr="scrolled",Hy="overflow",s0="destroy",tp="arrows:mounted",np="arrows:updated",ip="pagination:mounted",rp="pagination:updated",o0="navigation:mounted",a0="autoplay:play",sp="autoplay:playing",l0="autoplay:pause",c0="lazyload:loaded",op="sk",ap="sh",Ra="ei";function yt(n){var e=n?n.event.bus:document.createDocumentFragment(),t=q2();function i(s,o){t.bind(e,ho(s).join(" "),function(a){o.apply(o,ju(a.detail)?a.detail:[])})}function r(s){t.dispatch(e,s,Vi(arguments,1))}return n&&n.event.on(s0,t.destroy),Js(t,{bus:e,on:i,off:ht(t.unbind,e),emit:r})}function Za(n,e,t,i){var r=Date.now,s,o=0,a,l=!0,c=0;function u(){if(!l){if(o=n?Oi((r()-s)/n,1):1,t&&t(o),o>=1&&(e(),s=r(),i&&++c>=i))return h();a=xh(u)}}function f(p){p||g(),s=r()-(p?o*n:0),l=!1,a=xh(u)}function h(){l=!0}function d(){s=r(),o=0,t&&t(o)}function g(){a&&cancelAnimationFrame(a),o=0,a=0,l=!0}function _(p){n=p}function m(){return l}return{start:f,rewind:d,pause:h,cancel:g,set:_,isPaused:m}}function zy(n){var e=n;function t(r){e=r}function i(r){return Qu(ho(r),e)}return{set:t,is:i}}function Vy(n,e){var t=Za(0,n,null,1);return function(){t.isPaused()&&t.start()}}function ky(n,e,t){var i=n.state,r=t.breakpoints||{},s=t.reducedMotion||{},o=q2(),a=[];function l(){var g=t.mediaQuery==="min";js(r).sort(function(_,m){return g?+_-+m:+m-+_}).forEach(function(_){u(r[_],"("+(g?"min":"max")+"-width:"+_+"px)")}),u(s,vh),f()}function c(g){g&&o.destroy()}function u(g,_){var m=matchMedia(_);o.bind(m,"change",f),a.push([g,m])}function f(){var g=i.is(Aa),_=t.direction,m=a.reduce(function(p,E){return Ai(p,E[1].matches?E[0]:{})},{});Sh(t),d(m),t.destroy?n.destroy(t.destroy==="completely"):g?(c(!0),n.mount()):_!==t.direction&&n.refresh()}function h(g){matchMedia(vh).matches&&(g?Ai(t,s):Sh(t,js(s)))}function d(g,_,m){Ai(t,g),_&&Ai(Object.getPrototypeOf(t),g),(m||!i.is(zr))&&n.emit(Gt,t)}return{setup:l,destroy:c,reduce:h,set:d}}var Ka="Arrow",ja=Ka+"Left",Ja=Ka+"Right",lp=Ka+"Up",cp=Ka+"Down",Ch="rtl",Qa="ttb",Ql={width:["height"],left:["top","right"],right:["bottom","left"],x:["y"],X:["Y"],Y:["X"],ArrowLeft:[lp,Ja],ArrowRight:[cp,ja]};function Gy(n,e,t){function i(s,o,a){a=a||t.direction;var l=a===Ch&&!o?1:a===Qa?0:-1;return Ql[s]&&Ql[s][l]||s.replace(/width|left|right/i,function(c,u){var f=Ql[c.toLowerCase()][l]||c;return u>0?f.charAt(0).toUpperCase()+f.slice(1):f})}function r(s){return s*(t.direction===Ch?1:-1)}return{resolve:i,orient:r}}var ai="role",Zr="tabindex",Wy="disabled",Ln="aria-",_o=Ln+"controls",up=Ln+"current",Th=Ln+"selected",mn=Ln+"label",u0=Ln+"labelledby",fp=Ln+"hidden",f0=Ln+"orientation",to=Ln+"roledescription",Ah=Ln+"live",bh=Ln+"busy",wh=Ln+"atomic",h0=[ai,Zr,Wy,_o,up,mn,u0,fp,f0,to],Gn=go+"__",Gi="is-",ec=go,Rh=Gn+"track",Xy=Gn+"list",el=Gn+"slide",hp=el+"--clone",$y=el+"__container",d0=Gn+"arrows",tl=Gn+"arrow",dp=tl+"--prev",pp=tl+"--next",nl=Gn+"pagination",mp=nl+"__page",qy=Gn+"progress",Yy=qy+"__bar",Zy=Gn+"toggle",Ky=Gn+"spinner",jy=Gn+"sr",Jy=Gi+"initialized",gr=Gi+"active",gp=Gi+"prev",_p=Gi+"next",uu=Gi+"visible",fu=Gi+"loading",vp=Gi+"focus-in",xp=Gi+"overflow",Qy=[gr,uu,gp,_p,fu,vp,xp],e6={slide:el,clone:hp,arrows:d0,arrow:tl,prev:dp,next:pp,pagination:nl,page:mp,spinner:Ky};function t6(n,e){if(z2(n.closest))return n.closest(e);for(var t=n;t&&t.nodeType===1&&!Ks(t,e);)t=t.parentElement;return t}var n6=5,Ph=200,Sp="touchstart mousedown",tc="touchmove mousemove",nc="touchend touchcancel mouseup click";function i6(n,e,t){var i=yt(n),r=i.on,s=i.bind,o=n.root,a=t.i18n,l={},c=[],u=[],f=[],h,d,g;function _(){S(),M(),E()}function m(){r(At,p),r(At,_),r(Gt,E),s(document,Sp+" keydown",function(R){g=R.type==="keydown"},{capture:!0}),s(o,"focusin",function(){ii(o,vp,!!g)})}function p(R){var I=h0.concat("style");ui(c),ri(o,u),ri(h,f),kn([h,d],I),kn(o,R?I:["style",to])}function E(){ri(o,u),ri(h,f),u=P(ec),f=P(Rh),Vn(o,u),Vn(h,f),Ze(o,mn,t.label),Ze(o,u0,t.labelledby)}function S(){h=L("."+Rh),d=mo(h,"."+Xy),Fs(h&&d,"A track/list element is missing."),ha(c,k2(d,"."+el+":not(."+hp+")")),fr({arrows:d0,pagination:nl,prev:dp,next:pp,bar:Yy,toggle:Zy},function(R,I){l[I]=L("."+R)}),Js(l,{root:o,track:h,list:d,slides:c})}function M(){var R=o.id||By(go),I=t.role;o.id=R,h.id=h.id||R+"-track",d.id=d.id||R+"-list",!An(o,ai)&&o.tagName!=="SECTION"&&I&&Ze(o,ai,I),Ze(o,to,a.carousel),Ze(d,ai,"presentation")}function L(R){var I=X2(o,R);return I&&t6(I,"."+ec)===o?I:void 0}function P(R){return[R+"--"+t.type,R+"--"+t.direction,t.drag&&R+"--draggable",t.isNavigation&&R+"--nav",R===ec&&gr]}return Js(l,{setup:_,mount:m,destroy:p})}var ls="slide",ds="loop",vo="fade";function r6(n,e,t,i){var r=yt(n),s=r.on,o=r.emit,a=r.bind,l=n.Components,c=n.root,u=n.options,f=u.isNavigation,h=u.updateOnMove,d=u.i18n,g=u.pagination,_=u.slideFocus,m=l.Direction.resolve,p=An(i,"style"),E=An(i,mn),S=t>-1,M=mo(i,"."+$y),L;function P(){S||(i.id=c.id+"-slide"+i0(e+1),Ze(i,ai,g?"tabpanel":"group"),Ze(i,to,d.slide),Ze(i,mn,E||cu(d.slideLabel,[e+1,n.length]))),R()}function R(){a(i,"click",ht(o,r0,O)),a(i,"keydown",ht(o,op,O)),s([hs,ap,Sr],w),s(o0,A),h&&s(fi,y)}function I(){L=!0,r.destroy(),ri(i,Qy),kn(i,h0),Ze(i,"style",p),Ze(i,mn,E||"")}function A(){var se=n.splides.map(function(K){var ue=K.splide.Components.Slides.getAt(e);return ue?ue.slide.id:""}).join(" ");Ze(i,mn,cu(d.slideX,(S?t:e)+1)),Ze(i,_o,se),Ze(i,ai,_?"button":""),_&&kn(i,to)}function y(){L||w()}function w(){if(!L){var se=n.index;U(),D(),ii(i,gp,e===se-1),ii(i,_p,e===se+1)}}function U(){var se=W();se!==Mh(i,gr)&&(ii(i,gr,se),Ze(i,up,f&&se||""),o(se?Y2:Z2,O))}function D(){var se=$(),K=!se&&(!W()||S);if(n.state.is([fs,uo])||Ze(i,fp,K||""),Ze(t0(i,u.focusableNodes||""),Zr,K?-1:""),_&&Ze(i,Zr,K?-1:0),se!==Mh(i,uu)&&(ii(i,uu,se),o(se?K2:j2,O)),!se&&document.activeElement===i){var ue=l.Slides.getAt(n.index);ue&&G2(ue.slide)}}function G(se,K,ue){yn(ue&&M||i,se,K)}function W(){var se=n.index;return se===e||u.cloneStatus&&se===t}function $(){if(n.is(vo))return W();var se=dn(l.Elements.track),K=dn(i),ue=m("left",!0),Ee=m("right",!0);return wa(se[ue])<=eo(K[ue])&&wa(K[Ee])<=eo(se[Ee])}function q(se,K){var ue=Zt(se-e);return!S&&(u.rewind||n.is(ds))&&(ue=Oi(ue,n.length-ue)),ue<=K}var O={index:e,slideIndex:t,slide:i,container:M,isClone:S,mount:P,destroy:I,update:w,style:G,isWithin:q};return O}function s6(n,e,t){var i=yt(n),r=i.on,s=i.emit,o=i.bind,a=e.Elements,l=a.slides,c=a.list,u=[];function f(){h(),r(At,d),r(At,h)}function h(){l.forEach(function(w,U){_(w,U,-1)})}function d(){L(function(w){w.destroy()}),ui(u)}function g(){L(function(w){w.update()})}function _(w,U,D){var G=r6(n,U,D,w);G.mount(),u.push(G),u.sort(function(W,$){return W.index-$.index})}function m(w){return w?P(function(U){return!U.isClone}):u}function p(w){var U=e.Controller,D=U.toIndex(w),G=U.hasFocus()?1:t.perPage;return P(function(W){return da(W.index,D,D+G-1)})}function E(w){return P(w)[0]}function S(w,U){gn(w,function(D){if(Fi(D)&&(D=W2(D)),V2(D)){var G=l[U];G?e0(D,G):po(c,D),Vn(D,t.classes.slide),I(D,ht(s,as))}}),s(At)}function M(w){mr(P(w).map(function(U){return U.slide})),s(At)}function L(w,U){m(U).forEach(w)}function P(w){return u.filter(z2(w)?w:function(U){return Fi(w)?Ks(U.slide,w):Qu(ho(w),U.index)})}function R(w,U,D){L(function(G){G.style(w,U,D)})}function I(w,U){var D=t0(w,"img"),G=D.length;G?D.forEach(function(W){o(W,"load error",function(){--G||U()})}):U()}function A(w){return w?l.length:u.length}function y(){return u.length>t.perPage}return{mount:f,destroy:d,update:g,register:_,get:m,getIn:p,getAt:E,add:S,remove:M,forEach:L,filter:P,style:R,getLength:A,isEnough:y}}function o6(n,e,t){var i=yt(n),r=i.on,s=i.bind,o=i.emit,a=e.Slides,l=e.Direction.resolve,c=e.Elements,u=c.root,f=c.track,h=c.list,d=a.getAt,g=a.style,_,m,p;function E(){S(),s(window,"resize load",Vy(ht(o,as))),r([Gt,At],S),r(as,M)}function S(){_=t.direction===Qa,yn(u,"maxWidth",er(t.width)),yn(f,l("paddingLeft"),L(!1)),yn(f,l("paddingRight"),L(!0)),M(!0)}function M(O){var se=dn(u);(O||m.width!==se.width||m.height!==se.height)&&(yn(f,"height",P()),g(l("marginRight"),er(t.gap)),g("width",I()),g("height",A(),!0),m=se,o(qa),p!==(p=q())&&(ii(u,xp,p),o(Hy,p)))}function L(O){var se=t.padding,K=l(O?"right":"left");return se&&er(se[K]||(Zs(se)?0:se))||"0px"}function P(){var O="";return _&&(O=R(),Fs(O,"height or heightRatio is missing."),O="calc("+O+" - "+L(!1)+" - "+L(!0)+")"),O}function R(){return er(t.height||dn(h).width*t.heightRatio)}function I(){return t.autoWidth?null:er(t.fixedWidth)||(_?"":y())}function A(){return er(t.fixedHeight)||(_?t.autoHeight?null:y():R())}function y(){var O=er(t.gap);return"calc((100%"+(O&&" + "+O)+")/"+(t.perPage||1)+(O&&" - "+O)+")"}function w(){return dn(h)[l("width")]}function U(O,se){var K=d(O||0);return K?dn(K.slide)[l("width")]+(se?0:W()):0}function D(O,se){var K=d(O);if(K){var ue=dn(K.slide)[l("right")],Ee=dn(h)[l("left")];return Zt(ue-Ee)+(se?0:W())}return 0}function G(O){return D(n.length-1)-D(0)+U(0,O)}function W(){var O=d(0);return O&&parseFloat(yn(O.slide,l("marginRight")))||0}function $(O){return parseFloat(yn(f,l("padding"+(O?"Right":"Left"))))||0}function q(){return n.is(vo)||G(!0)>w()}return{mount:E,resize:M,listSize:w,slideSize:U,sliderSize:G,totalSize:D,getPadding:$,isOverflow:q}}var a6=2;function l6(n,e,t){var i=yt(n),r=i.on,s=e.Elements,o=e.Slides,a=e.Direction.resolve,l=[],c;function u(){r(At,f),r([Gt,as],d),(c=m())&&(g(c),e.Layout.resize(!0))}function f(){h(),u()}function h(){mr(l),ui(l),i.destroy()}function d(){var p=m();c!==p&&(c<p||!p)&&i.emit(At)}function g(p){var E=o.get().slice(),S=E.length;if(S){for(;E.length<p;)ha(E,E);ha(E.slice(-p),E.slice(0,p)).forEach(function(M,L){var P=L<p,R=_(M.slide,L);P?e0(R,E[0].slide):po(s.list,R),ha(l,R),o.register(R,L-p+(P?0:S),M.index)})}}function _(p,E){var S=p.cloneNode(!0);return Vn(S,t.classes.clone),S.id=n.root.id+"-clone"+i0(E+1),S}function m(){var p=t.clones;if(!n.is(ds))p=0;else if(fo(p)){var E=t[a("fixedWidth")]&&e.Layout.slideSize(0),S=E&&eo(dn(s.track)[a("width")]/E);p=S||t[a("autoWidth")]&&n.length||t.perPage*a6}return p}return{mount:u,destroy:h}}function c6(n,e,t){var i=yt(n),r=i.on,s=i.emit,o=n.state.set,a=e.Layout,l=a.slideSize,c=a.getPadding,u=a.totalSize,f=a.listSize,h=a.sliderSize,d=e.Direction,g=d.resolve,_=d.orient,m=e.Elements,p=m.list,E=m.track,S;function M(){S=e.Transition,r([ki,qa,Gt,At],L)}function L(){e.Controller.isBusy()||(e.Scroll.cancel(),R(n.index),e.Slides.update())}function P(K,ue,Ee,Oe){K!==ue&&O(K>Ee)&&(w(),I(y(G(),K>Ee),!0)),o(fs),s(fi,ue,Ee,K),S.start(ue,function(){o(os),s(hs,ue,Ee,K),Oe&&Oe()})}function R(K){I(D(K,!0))}function I(K,ue){if(!n.is(vo)){var Ee=ue?K:A(K);yn(p,"transform","translate"+g("X")+"("+Ee+"px)"),K!==Ee&&s(ap)}}function A(K){if(n.is(ds)){var ue=U(K),Ee=ue>e.Controller.getEnd(),Oe=ue<0;(Oe||Ee)&&(K=y(K,Ee))}return K}function y(K,ue){var Ee=K-q(ue),Oe=h();return K-=_(Oe*(eo(Zt(Ee)/Oe)||1))*(ue?1:-1),K}function w(){I(G(),!0),S.cancel()}function U(K){for(var ue=e.Slides.get(),Ee=0,Oe=1/0,ie=0;ie<ue.length;ie++){var _e=ue[ie].index,J=Zt(D(_e,!0)-K);if(J<=Oe)Oe=J,Ee=_e;else break}return Ee}function D(K,ue){var Ee=_(u(K-1)-$(K));return ue?W(Ee):Ee}function G(){var K=g("left");return dn(p)[K]-dn(E)[K]+_(c(!1))}function W(K){return t.trimSpace&&n.is(ls)&&(K=Or(K,0,_(h(!0)-f()))),K}function $(K){var ue=t.focus;return ue==="center"?(f()-l(K,!0))/2:+ue*l(K)||0}function q(K){return D(K?e.Controller.getEnd():0,!!t.trimSpace)}function O(K){var ue=_(y(G(),K));return K?ue>=0:ue<=p[g("scrollWidth")]-dn(E)[g("width")]}function se(K,ue){ue=fo(ue)?G():ue;var Ee=K!==!0&&_(ue)<_(q(!1)),Oe=K!==!1&&_(ue)>_(q(!0));return Ee||Oe}return{mount:M,move:P,jump:R,translate:I,shift:y,cancel:w,toIndex:U,toPosition:D,getPosition:G,getLimit:q,exceededLimit:se,reposition:L}}function u6(n,e,t){var i=yt(n),r=i.on,s=i.emit,o=e.Move,a=o.getPosition,l=o.getLimit,c=o.toPosition,u=e.Slides,f=u.isEnough,h=u.getLength,d=t.omitEnd,g=n.is(ds),_=n.is(ls),m=ht(G,!1),p=ht(G,!0),E=t.start||0,S,M=E,L,P,R;function I(){A(),r([Gt,At,Ra],A),r(qa,y)}function A(){L=h(!0),P=t.perMove,R=t.perPage,S=O();var J=Or(E,0,d?S:L-1);J!==E&&(E=J,o.reposition())}function y(){S!==O()&&s(Ra)}function w(J,N,re){if(!_e()){var ae=D(J),le=q(ae);le>-1&&(N||le!==E)&&(Ee(le),o.move(ae,le,M,re))}}function U(J,N,re,ae){e.Scroll.scroll(J,N,re,function(){var le=q(o.toIndex(a()));Ee(d?Oi(le,S):le),ae&&ae()})}function D(J){var N=E;if(Fi(J)){var re=J.match(/([+\-<>])(\d+)?/)||[],ae=re[1],le=re[2];ae==="+"||ae==="-"?N=W(E+ +(""+ae+(+le||1)),E):ae===">"?N=le?se(+le):m(!0):ae==="<"&&(N=p(!0))}else N=g?J:Or(J,0,S);return N}function G(J,N){var re=P||(ie()?1:R),ae=W(E+re*(J?-1:1),E,!(P||ie()));return ae===-1&&_&&!$2(a(),l(!J),1)?J?0:S:N?ae:q(ae)}function W(J,N,re){if(f()||ie()){var ae=$(J);ae!==J&&(N=J,J=ae,re=!1),J<0||J>S?!P&&(da(0,J,N,!0)||da(S,N,J,!0))?J=se(K(J)):g?J=re?J<0?-(L%R||R):L:J:t.rewind?J=J<0?S:0:J=-1:re&&J!==N&&(J=se(K(N)+(J<N?-1:1)))}else J=-1;return J}function $(J){if(_&&t.trimSpace==="move"&&J!==E)for(var N=a();N===c(J,!0)&&da(J,0,n.length-1,!t.rewind);)J<E?--J:++J;return J}function q(J){return g?(J+L)%L||0:J}function O(){for(var J=L-(ie()||g&&P?1:R);d&&J-- >0;)if(c(L-1,!0)!==c(J,!0)){J++;break}return Or(J,0,L-1)}function se(J){return Or(ie()?J:R*J,0,S)}function K(J){return ie()?Oi(J,S):wa((J>=S?L-1:J)/R)}function ue(J){var N=o.toIndex(J);return _?Or(N,0,S):N}function Ee(J){J!==E&&(M=E,E=J)}function Oe(J){return J?M:E}function ie(){return!fo(t.focus)||t.isNavigation}function _e(){return n.state.is([fs,uo])&&!!t.waitForTransition}return{mount:I,go:w,scroll:U,getNext:m,getPrev:p,getAdjacent:G,getEnd:O,setIndex:Ee,getIndex:Oe,toIndex:se,toPage:K,toDest:ue,hasFocus:ie,isBusy:_e}}var f6="http://www.w3.org/2000/svg",h6="m15.5 0.932-4.3 4.38 14.5 14.6-14.5 14.5 4.3 4.4 14.6-14.6 4.4-4.3-4.4-4.4-14.6-14.6z",ea=40;function d6(n,e,t){var i=yt(n),r=i.on,s=i.bind,o=i.emit,a=t.classes,l=t.i18n,c=e.Elements,u=e.Controller,f=c.arrows,h=c.track,d=f,g=c.prev,_=c.next,m,p,E={};function S(){L(),r(Gt,M)}function M(){P(),S()}function L(){var U=t.arrows;U&&!(g&&_)&&A(),g&&_&&(Js(E,{prev:g,next:_}),Qs(d,U?"":"none"),Vn(d,p=d0+"--"+t.direction),U&&(R(),w(),Ze([g,_],_o,h.id),o(tp,g,_)))}function P(){i.destroy(),ri(d,p),m?(mr(f?[g,_]:d),g=_=null):kn([g,_],h0)}function R(){r([ki,hs,At,Sr,Ra],w),s(_,"click",ht(I,">")),s(g,"click",ht(I,"<"))}function I(U){u.go(U,!0)}function A(){d=f||Yr("div",a.arrows),g=y(!0),_=y(!1),m=!0,po(d,[g,_]),!f&&e0(d,h)}function y(U){var D='<button class="'+a.arrow+" "+(U?a.prev:a.next)+'" type="button"><svg xmlns="'+f6+'" viewBox="0 0 '+ea+" "+ea+'" width="'+ea+'" height="'+ea+'" focusable="false"><path d="'+(t.arrowPath||h6)+'" />';return W2(D)}function w(){if(g&&_){var U=n.index,D=u.getPrev(),G=u.getNext(),W=D>-1&&U<D?l.last:l.prev,$=G>-1&&U>G?l.first:l.next;g.disabled=D<0,_.disabled=G<0,Ze(g,mn,W),Ze(_,mn,$),o(np,g,_,D,G)}}return{arrows:E,mount:S,destroy:P,update:w}}var p6=n0+"-interval";function m6(n,e,t){var i=yt(n),r=i.on,s=i.bind,o=i.emit,a=Za(t.interval,n.go.bind(n,">"),R),l=a.isPaused,c=e.Elements,u=e.Elements,f=u.root,h=u.toggle,d=t.autoplay,g,_,m=d==="pause";function p(){d&&(E(),h&&Ze(h,_o,c.track.id),m||S(),P())}function E(){t.pauseOnHover&&s(f,"mouseenter mouseleave",function(A){g=A.type==="mouseenter",L()}),t.pauseOnFocus&&s(f,"focusin focusout",function(A){_=A.type==="focusin",L()}),h&&s(h,"click",function(){m?S():M(!0)}),r([fi,Ya,At],a.rewind),r(fi,I)}function S(){l()&&e.Slides.isEnough()&&(a.start(!t.resetProgress),_=g=m=!1,P(),o(a0))}function M(A){A===void 0&&(A=!0),m=!!A,P(),l()||(a.pause(),o(l0))}function L(){m||(g||_?M(!1):S())}function P(){h&&(ii(h,gr,!m),Ze(h,mn,t.i18n[m?"play":"pause"]))}function R(A){var y=c.bar;y&&yn(y,"width",A*100+"%"),o(sp,A)}function I(A){var y=e.Slides.getAt(A);a.set(y&&+An(y.slide,p6)||t.interval)}return{mount:p,destroy:a.cancel,play:S,pause:M,isPaused:l}}function g6(n,e,t){var i=yt(n),r=i.on;function s(){t.cover&&(r(c0,ht(a,!0)),r([ki,Gt,At],ht(o,!0)))}function o(l){e.Slides.forEach(function(c){var u=mo(c.container||c.slide,"img");u&&u.src&&a(l,u,c)})}function a(l,c,u){u.style("background",l?'center/cover no-repeat url("'+c.src+'")':"",!0),Qs(c,l?"none":"")}return{mount:s,destroy:ht(o,!1)}}var _6=10,v6=600,x6=.6,S6=1.5,M6=800;function y6(n,e,t){var i=yt(n),r=i.on,s=i.emit,o=n.state.set,a=e.Move,l=a.getPosition,c=a.getLimit,u=a.exceededLimit,f=a.translate,h=n.is(ls),d,g,_=1;function m(){r(fi,M),r([Gt,At],L)}function p(R,I,A,y,w){var U=l();if(M(),A&&(!h||!u())){var D=e.Layout.sliderSize(),G=lu(R)*D*wa(Zt(R)/D)||0;R=a.toPosition(e.Controller.toDest(R%D))+G}var W=$2(U,R,1);_=1,I=W?0:I||ba(Zt(R-U)/S6,M6),g=y,d=Za(I,E,ht(S,U,R,w),1),o(uo),s(Ya),d.start()}function E(){o(os),g&&g(),s(Sr)}function S(R,I,A,y){var w=l(),U=R+(I-R)*P(y),D=(U-w)*_;f(w+D),h&&!A&&u()&&(_*=x6,Zt(D)<_6&&p(c(u(!0)),v6,!1,g,!0))}function M(){d&&d.cancel()}function L(){d&&!d.isPaused()&&(M(),E())}function P(R){var I=t.easingFunc;return I?I(R):1-Math.pow(1-R,4)}return{mount:m,destroy:M,scroll:p,cancel:L}}var Br={passive:!1,capture:!0};function E6(n,e,t){var i=yt(n),r=i.on,s=i.emit,o=i.bind,a=i.unbind,l=n.state,c=e.Move,u=e.Scroll,f=e.Controller,h=e.Elements.track,d=e.Media.reduce,g=e.Direction,_=g.resolve,m=g.orient,p=c.getPosition,E=c.exceededLimit,S,M,L,P,R,I=!1,A,y,w;function U(){o(h,tc,ou,Br),o(h,nc,ou,Br),o(h,Sp,G,Br),o(h,"click",q,{capture:!0}),o(h,"dragstart",Qn),r([ki,Gt],D)}function D(){var C=t.drag;ze(!C),P=C==="free"}function G(C){if(A=!1,!y){var v=le(C);ae(C.target)&&(v||!C.button)&&(f.isBusy()?Qn(C,!0):(w=v?h:window,R=l.is([fs,uo]),L=null,o(w,tc,W,Br),o(w,nc,$,Br),c.cancel(),u.cancel(),O(C)))}}function W(C){if(l.is(fa)||(l.set(fa),s(J2)),C.cancelable)if(R){c.translate(S+re(ie(C)));var v=_e(C)>Ph,k=I!==(I=E());(v||k)&&O(C),A=!0,s(Q2),Qn(C)}else ue(C)&&(R=K(C),Qn(C))}function $(C){l.is(fa)&&(l.set(os),s(ep)),R&&(se(C),Qn(C)),a(w,tc,W),a(w,nc,$),R=!1}function q(C){!y&&A&&Qn(C,!0)}function O(C){L=M,M=C,S=p()}function se(C){var v=Ee(C),k=Oe(v),ne=t.rewind&&t.rewindByDrag;d(!1),P?f.scroll(k,0,t.snap):n.is(vo)?f.go(m(lu(v))<0?ne?"<":"-":ne?">":"+"):n.is(ls)&&I&&ne?f.go(E(!0)?">":"<"):f.go(f.toDest(k),!0),d(!0)}function K(C){var v=t.dragMinThreshold,k=Zs(v),ne=k&&v.mouse||0,j=(k?v.touch:+v)||10;return Zt(ie(C))>(le(C)?j:ne)}function ue(C){return Zt(ie(C))>Zt(ie(C,!0))}function Ee(C){if(n.is(ds)||!I){var v=_e(C);if(v&&v<Ph)return ie(C)/v}return 0}function Oe(C){return p()+lu(C)*Oi(Zt(C)*(t.flickPower||600),P?1/0:e.Layout.listSize()*(t.flickMaxPages||1))}function ie(C,v){return N(C,v)-N(J(C),v)}function _e(C){return au(C)-au(J(C))}function J(C){return M===C&&L||M}function N(C,v){return(le(C)?C.changedTouches[0]:C)["page"+_(v?"Y":"X")]}function re(C){return C/(I&&n.is(ls)?n6:1)}function ae(C){var v=t.noDrag;return!Ks(C,"."+mp+", ."+tl)&&(!v||!Ks(C,v))}function le(C){return typeof TouchEvent<"u"&&C instanceof TouchEvent}function Ne(){return R}function ze(C){y=C}return{mount:U,disable:ze,isDragging:Ne}}var C6={Spacebar:" ",Right:Ja,Left:ja,Up:lp,Down:cp};function p0(n){return n=Fi(n)?n:n.key,C6[n]||n}var Lh="keydown";function T6(n,e,t){var i=yt(n),r=i.on,s=i.bind,o=i.unbind,a=n.root,l=e.Direction.resolve,c,u;function f(){h(),r(Gt,d),r(Gt,h),r(fi,_)}function h(){var p=t.keyboard;p&&(c=p==="global"?window:a,s(c,Lh,m))}function d(){o(c,Lh)}function g(p){u=p}function _(){var p=u;u=!0,H2(function(){u=p})}function m(p){if(!u){var E=p0(p);E===l(ja)?n.go("<"):E===l(Ja)&&n.go(">")}}return{mount:f,destroy:d,disable:g}}var Os=n0+"-lazy",pa=Os+"-srcset",A6="["+Os+"], ["+pa+"]";function b6(n,e,t){var i=yt(n),r=i.on,s=i.off,o=i.bind,a=i.emit,l=t.lazyLoad==="sequential",c=[hs,Sr],u=[];function f(){t.lazyLoad&&(h(),r(At,h))}function h(){ui(u),d(),l?p():(s(c),r(c,g),g())}function d(){e.Slides.forEach(function(E){t0(E.slide,A6).forEach(function(S){var M=An(S,Os),L=An(S,pa);if(M!==S.src||L!==S.srcset){var P=t.classes.spinner,R=S.parentElement,I=mo(R,"."+P)||Yr("span",P,R);u.push([S,E,I]),S.src||Qs(S,"none")}})})}function g(){u=u.filter(function(E){var S=t.perPage*((t.preloadPages||1)+1)-1;return E[1].isWithin(n.index,S)?_(E):!0}),u.length||s(c)}function _(E){var S=E[0];Vn(E[1].slide,fu),o(S,"load error",ht(m,E)),Ze(S,"src",An(S,Os)),Ze(S,"srcset",An(S,pa)),kn(S,Os),kn(S,pa)}function m(E,S){var M=E[0],L=E[1];ri(L.slide,fu),S.type!=="error"&&(mr(E[2]),Qs(M,""),a(c0,M,L),a(as)),l&&p()}function p(){u.length&&_(u.shift())}return{mount:f,destroy:ht(ui,u),check:g}}function w6(n,e,t){var i=yt(n),r=i.on,s=i.emit,o=i.bind,a=e.Slides,l=e.Elements,c=e.Controller,u=c.hasFocus,f=c.getIndex,h=c.go,d=e.Direction.resolve,g=l.pagination,_=[],m,p;function E(){S(),r([Gt,At,Ra],E);var y=t.pagination;g&&Qs(g,y?"":"none"),y&&(r([fi,Ya,Sr],A),M(),A(),s(ip,{list:m,items:_},I(n.index)))}function S(){m&&(mr(g?Vi(m.children):m),ri(m,p),ui(_),m=null),i.destroy()}function M(){var y=n.length,w=t.classes,U=t.i18n,D=t.perPage,G=u()?c.getEnd()+1:eo(y/D);m=g||Yr("ul",w.pagination,l.track.parentElement),Vn(m,p=nl+"--"+R()),Ze(m,ai,"tablist"),Ze(m,mn,U.select),Ze(m,f0,R()===Qa?"vertical":"");for(var W=0;W<G;W++){var $=Yr("li",null,m),q=Yr("button",{class:w.page,type:"button"},$),O=a.getIn(W).map(function(K){return K.slide.id}),se=!u()&&D>1?U.pageX:U.slideX;o(q,"click",ht(L,W)),t.paginationKeyboard&&o(q,"keydown",ht(P,W)),Ze($,ai,"presentation"),Ze(q,ai,"tab"),Ze(q,_o,O.join(" ")),Ze(q,mn,cu(se,W+1)),Ze(q,Zr,-1),_.push({li:$,button:q,page:W})}}function L(y){h(">"+y,!0)}function P(y,w){var U=_.length,D=p0(w),G=R(),W=-1;D===d(Ja,!1,G)?W=++y%U:D===d(ja,!1,G)?W=(--y+U)%U:D==="Home"?W=0:D==="End"&&(W=U-1);var $=_[W];$&&(G2($.button),h(">"+W),Qn(w,!0))}function R(){return t.paginationDirection||t.direction}function I(y){return _[c.toPage(y)]}function A(){var y=I(f(!0)),w=I(f());if(y){var U=y.button;ri(U,gr),kn(U,Th),Ze(U,Zr,-1)}if(w){var D=w.button;Vn(D,gr),Ze(D,Th,!0),Ze(D,Zr,"")}s(rp,{list:m,items:_},y,w)}return{items:_,mount:E,destroy:S,getAt:I,update:A}}var R6=[" ","Enter"];function P6(n,e,t){var i=t.isNavigation,r=t.slideFocus,s=[];function o(){n.splides.forEach(function(g){g.isParent||(c(n,g.splide),c(g.splide,n))}),i&&u()}function a(){s.forEach(function(g){g.destroy()}),ui(s)}function l(){a(),o()}function c(g,_){var m=yt(g);m.on(fi,function(p,E,S){_.go(_.is(ds)?S:p)}),s.push(m)}function u(){var g=yt(n),_=g.on;_(r0,h),_(op,d),_([ki,Gt],f),s.push(g),g.emit(o0,n.splides)}function f(){Ze(e.Elements.list,f0,t.direction===Qa?"vertical":"")}function h(g){n.go(g.index)}function d(g,_){Qu(R6,p0(_))&&(h(g),Qn(_))}return{setup:ht(e.Media.set,{slideFocus:fo(r)?i:r},!0),mount:o,destroy:a,remount:l}}function L6(n,e,t){var i=yt(n),r=i.bind,s=0;function o(){t.wheel&&r(e.Elements.track,"wheel",a,Br)}function a(c){if(c.cancelable){var u=c.deltaY,f=u<0,h=au(c),d=t.wheelMinThreshold||0,g=t.wheelSleep||0;Zt(u)>d&&h-s>g&&(n.go(f?"<":">"),s=h),l(f)&&Qn(c)}}function l(c){return!t.releaseWheel||n.state.is(fs)||e.Controller.getAdjacent(c)!==-1}return{mount:o}}var I6=90;function D6(n,e,t){var i=yt(n),r=i.on,s=e.Elements.track,o=t.live&&!t.isNavigation,a=Yr("span",jy),l=Za(I6,ht(u,!1));function c(){o&&(h(!e.Autoplay.isPaused()),Ze(s,wh,!0),a.textContent="…",r(a0,ht(h,!0)),r(l0,ht(h,!1)),r([hs,Sr],ht(u,!0)))}function u(d){Ze(s,bh,d),d?(po(s,a),l.start()):(mr(a),l.cancel())}function f(){kn(s,[Ah,wh,bh]),mr(a)}function h(d){o&&Ze(s,Ah,d?"off":"polite")}return{mount:c,disable:h,destroy:f}}var U6=Object.freeze({__proto__:null,Media:ky,Direction:Gy,Elements:i6,Slides:s6,Layout:o6,Clones:l6,Move:c6,Controller:u6,Arrows:d6,Autoplay:m6,Cover:g6,Scroll:y6,Drag:E6,Keyboard:T6,LazyLoad:b6,Pagination:w6,Sync:P6,Wheel:L6,Live:D6}),N6={prev:"Previous slide",next:"Next slide",first:"Go to first slide",last:"Go to last slide",slideX:"Go to slide %s",pageX:"Go to page %s",play:"Start autoplay",pause:"Pause autoplay",carousel:"carousel",slide:"slide",select:"Select a slide to show",slideLabel:"%s of %s"},F6={type:"slide",role:"region",speed:400,perPage:1,cloneStatus:!0,arrows:!0,pagination:!0,paginationKeyboard:!0,interval:5e3,pauseOnHover:!0,pauseOnFocus:!0,resetProgress:!0,easing:"cubic-bezier(0.25, 1, 0.5, 1)",drag:!0,direction:"ltr",trimSpace:!0,focusableNodes:"a, button, textarea, input, select, iframe",live:!0,classes:e6,i18n:N6,reducedMotion:{speed:0,rewindSpeed:0,autoplay:"pause"}};function O6(n,e,t){var i=e.Slides;function r(){yt(n).on([ki,At],s)}function s(){i.forEach(function(a){a.style("transform","translateX(-"+100*a.index+"%)")})}function o(a,l){i.style("transition","opacity "+t.speed+"ms "+t.easing),H2(l)}return{mount:r,start:o,cancel:ou}}function B6(n,e,t){var i=e.Move,r=e.Controller,s=e.Scroll,o=e.Elements.list,a=ht(yn,o,"transition"),l;function c(){yt(n).bind(o,"transitionend",function(d){d.target===o&&l&&(f(),l())})}function u(d,g){var _=i.toPosition(d,!0),m=i.getPosition(),p=h(d);Zt(_-m)>=1&&p>=1?t.useScroll?s.scroll(_,p,!1,g):(a("transform "+p+"ms "+t.easing),i.translate(_,!0),l=g):(i.jump(d),g())}function f(){a(""),s.cancel()}function h(d){var g=t.rewindSpeed;if(n.is(ls)&&g){var _=r.getIndex(!0),m=r.getEnd();if(_===0&&d>=m||_>=m&&d===0)return g}return t.speed}return{mount:c,start:u,cancel:f}}var H6=function(){function n(t,i){this.event=yt(),this.Components={},this.state=zy(zr),this.splides=[],this._o={},this._E={};var r=Fi(t)?X2(document,t):t;Fs(r,r+" is invalid."),this.root=r,i=Ai({label:An(r,mn)||"",labelledby:An(r,u0)||""},F6,n.defaults,i||{});try{Ai(i,JSON.parse(An(r,n0)))}catch{Fs(!1,"Invalid JSON")}this._o=Object.create(Ai({},i))}var e=n.prototype;return e.mount=function(i,r){var s=this,o=this.state,a=this.Components;Fs(o.is([zr,Aa]),"Already mounted!"),o.set(zr),this._C=a,this._T=r||this._T||(this.is(vo)?O6:B6),this._E=i||this._E;var l=Js({},U6,this._E,{Transition:this._T});return fr(l,function(c,u){var f=c(s,a,s._o);a[u]=f,f.setup&&f.setup()}),fr(a,function(c){c.mount&&c.mount()}),this.emit(ki),Vn(this.root,Jy),o.set(os),this.emit(Eh),this},e.sync=function(i){return this.splides.push({splide:i}),i.splides.push({splide:this,isParent:!0}),this.state.is(os)&&(this._C.Sync.remount(),i.Components.Sync.remount()),this},e.go=function(i){return this._C.Controller.go(i),this},e.on=function(i,r){return this.event.on(i,r),this},e.off=function(i){return this.event.off(i),this},e.emit=function(i){var r;return(r=this.event).emit.apply(r,[i].concat(Vi(arguments,1))),this},e.add=function(i,r){return this._C.Slides.add(i,r),this},e.remove=function(i){return this._C.Slides.remove(i),this},e.is=function(i){return this._o.type===i},e.refresh=function(){return this.emit(At),this},e.destroy=function(i){i===void 0&&(i=!0);var r=this.event,s=this.state;return s.is(zr)?yt(this).on(Eh,this.destroy.bind(this,i)):(fr(this._C,function(o){o.destroy&&o.destroy(i)},!0),r.emit(s0),r.destroy(),i&&ui(this.splides),s.set(Aa)),this},Ny(n,[{key:"options",get:function(){return this._o},set:function(i){this._C.Media.set(i,!0,!0)}},{key:"length",get:function(){return this._C.Slides.getLength(!0)}},{key:"index",get:function(){return this._C.Controller.getIndex()}}]),n}(),m0=H6;m0.defaults={};m0.STATES=Oy;const Ih=[Y2,tp,np,l0,a0,sp,r0,s0,J2,ep,Q2,j2,Z2,c0,ki,fi,hs,o0,ip,rp,At,as,qa,Ya,Sr,Gt,K2],Mp="splide";function Dh(n){return n!==null&&typeof n=="object"}function z6(n,e){if(n){const t=Object.keys(n);for(let i=0;i<t.length;i++){const r=t[i];if(r!=="__proto__"&&e(n[r],r)===!1)break}}return n}function yp(n,e){const t=n;return z6(e,(i,r)=>{Array.isArray(i)?t[r]=i.slice():Dh(i)?t[r]=yp(Dh(t[r])?t[r]:{},i):t[r]=i}),t}const V6=no({name:"SplideTrack",setup(){gd(()=>{var n;const e=Bn(Mp);(n=e==null?void 0:e.value)==null||n.refresh()})}}),g0=(n,e)=>{const t=n.__vccOpts||n;for(const[i,r]of e)t[i]=r;return t},k6={class:"splide__track"},G6={class:"splide__list"};function W6(n,e,t,i,r,s){return je(),st("div",k6,[ge("ul",G6,[ga(n.$slots,"default")])])}const Ep=g0(V6,[["render",W6]]),X6=no({name:"Splide",emits:Ih.map(n=>`splide:${n}`),components:{SplideTrack:Ep},props:{tag:{default:"div",type:String},options:{default:{},type:Object},extensions:Object,transition:Function,hasTrack:{default:!0,type:Boolean}},setup(n,e){const t=Fn(),i=Fn();vr(()=>{i.value&&(t.value=new m0(i.value,n.options),l(t.value),t.value.mount(n.extensions,n.transition))}),Ha(()=>{var c;(c=t.value)==null||c.destroy()}),Ls(()=>yp({},n.options),c=>{t.value&&(t.value.options=c)},{deep:!0}),Ps(Mp,t);const r=on(()=>{var c;return((c=t.value)==null?void 0:c.index)||0}),s=on(()=>{var c;return((c=t.value)==null?void 0:c.length)||0});function o(c){var u;(u=t.value)==null||u.go(c)}function a(c){var u;(u=t.value)==null||u.sync(c)}function l(c){Ih.forEach(u=>{c.on(u,(...f)=>{e.emit(`splide:${u}`,c,...f)})})}return{splide:t,root:i,index:r,length:s,go:o,sync:a}}});function $6(n,e,t,i,r,s){const o=Ru("SplideTrack");return je(),Ri(Rm(n.tag),{class:"splide",ref:"root"},{default:Wr(()=>[n.hasTrack?(je(),Ri(o,{key:0},{default:Wr(()=>[ga(n.$slots,"default")]),_:3})):ga(n.$slots,"default",{key:1})]),_:3},512)}const hu=g0(X6,[["render",$6]]),q6=no({name:"SplideSlide"}),Y6={class:"splide__slide"};function Z6(n,e,t,i,r,s){return je(),st("li",Y6,[ga(n.$slots,"default")])}const du=g0(q6,[["render",Z6]]),K6={install(n){n.component(hu.name,hu),n.component(du.name,du)}},j6={id:"experiences"},J6=ge("h2",{class:"title",id:"experiencestitle"},"Experiences",-1),Q6={class:"company"},eE={class:"techs"},tE={class:"experiences experiences__mobile"},nE={__name:"Experiences",setup(n){const e={perPage:1,type:"loop",pagination:!1,rewindByDrag:!0,fixedWidth:"70rem",arrowPath:"M16.8929 13.6928C17.2834 13.3023 17.9166 13.3023 18.3071 13.6928L23.9071 19.2928C24.0946 19.4803 24.2 19.7347 24.2 19.9999C24.2 20.2651 24.0946 20.5195 23.9071 20.707L18.3071 26.307C17.9166 26.6975 17.2834 26.6975 16.8929 26.307C16.5023 25.9165 16.5023 25.2833 16.8929 24.8928L21.7858 19.9999L16.8929 15.107C16.5023 14.7165 16.5023 14.0833 16.8929 13.6928Z"},t=[{time:"october 2024 - today",title:"Senior Web Developer",company:"Freelance",doings:["Reduced API call times by an average of 80% through advanced data prefetching, query optimization, and custom caching policies.","Boosted Core Web Vitals by adding skeleton loaders, lazy loading, and pagination for large datasets.","Integrated responsive PDF viewer with mobile optimization for smoother user access.","Created reusable React component libraries using Context API and Hooks.","Automated WordPress deployments to Vercel, enabling instant content updates after key changes.","Engineered custom Gutenberg blocks and advanced ACF setups for modular, flexible content editing.","Enhanced app integrations ( chatbot, UTM tracking, VWO A/B tests) and implemented structured SEO strategies including meta tags and rich schema.","Implemented secure CI/CD pipelines with GitHub Actions."]},{time:"july 2024 - october 2024",title:"Web Developer",company:"Mosyle ( Assetbots )",doings:["Built component-based UIs aligned with Figma designs using MUI and Styled Components.","Added features and enhancements to core interfaces using TypeScript and React.","Implemented and Improved A/B tests to measure UX changes and guide product improvements.","Upgraded backend APIs to support interactive features and secure data handling."]},{time:"april 2024 - october 2024",title:"Web Developer Freelance",company:"WKode",doings:["Built modular WordPress themes and custom ACF/Gutenberg blocks enabling flexible content management for 30+ websites.","Engineered custom Gutenberg blocks using React, TypeScript, and WordPress REST API for dynamic content editing.","Led development of headless architectures integrating WPGraphQL and microfrontend SPAs with React.","Built scalable component libraries using Hooks and Context API, improving developer efficiency.","Implemented secure CI/CD pipelines with GitHub Actions and Docker.","Improved performance and maintainability for headless WordPress SPAs with microfrontend architectures.","Integrated secure authentication using OAuth and built APIs with Express.js and GoLang ( Gin ).","Enhanced SEO with SSR, schema markup, and Lighthouse audits."]},{time:"april 2021 - april 2024",title:"Web Developer & UI/UX Designer",company:"JettaCargo",doings:["Built a 3D editor UI modeled after Blender, improving usability for customized cargo planning.","Created a microservice to dynamically generate PDF cargo reports, offering API-first users report access.","Designed and integrated a full onboarding tutorial system, reducing user drop-off during first-time interactions.","Led a complete UI/UX redesign of the company’s core web app for a more modern and intuitive interface.","Rebuilt corporate website in Nuxt.js, focusing on SEO and responsive UX.","Upgraded backend APIs to support interactive features and secure data handling.","Created reusable Vue component libraries, improving Component-Based architecture on the main webapp.","Implemented a custom chatbot and support ticket integration within the webapp."]},{time:"march 2020 - april 2021",title:"Front End Wordpress Developer",company:"Escritolândia",doings:["Designed and developed a custom e-commerce website from scratch using WordPress and WooCommerce.","Built a fully custom theme with a UI inspired by MercadoLivre and Amazon, optimized for conversion and speed.","Engineered dynamic Gutenberg blocks and ACF layouts to allow flexible content and product management.","Developed an integration between the website and the company’s internal system to sync product data and pricing in real time.","Implemented secure payment APIs to support various checkout flows.","Created icon fonts to reduce HTTP requests and improve overall load performance.","Led SEO strategies like schema markup, optimized image formats, improved loading speed, and structured internal links.","Set up tracking and behavior analytics using Google Analytics and Google Search Console to optimize product visibility.","Designed marketing materials and product images using Adobe tools.","Managed cloud infrastructure and DNS configurations, ensuring uptime and scalability.","Launched and monitored promotional campaigns with automated discounts and banners."]}];return(i,r)=>{const s=Ru("Technology");return je(),st("section",j6,[J6,_t(it(hu),{class:"experiences experiences__desktop",options:e,"has-track":!1,"aria-labelledby":"#experiencestitle"},{default:Wr(()=>[_t(it(Ep),null,{default:Wr(()=>[(je(),st(ut,null,Yt(t,(o,a)=>_t(it(du),{class:"experience",key:`experience${a}`},{default:Wr(()=>[ge("p",null,qt(o.time),1),ge("h4",null,[Jr(qt(o.title)+",",1),ge("span",Q6,qt(" "+o.company),1)]),ge("div",eE,[(je(!0),st(ut,null,Yt(o.techs,(l,c)=>(je(),Ri(s,{key:`tech-${c}`,technology:l},null,8,["technology"]))),128))]),ge("ul",null,[(je(!0),st(ut,null,Yt(o.doings,l=>(je(),st("li",null,qt(l),1))),256))])]),_:2},1024)),64))]),_:1})]),_:1}),ge("div",tE,[(je(),st(ut,null,Yt(t,(o,a)=>ge("div",{class:"experience is-active",key:`experience${a}`},[ge("p",null,qt(o.time),1),ge("h4",null,qt(o.title),1),ge("ul",null,[(je(!0),st(ut,null,Yt(o.doings,l=>(je(),st("li",null,qt(l),1))),256))])])),64))])])}}},iE={__name:"Home",setup(n){return(e,t)=>(je(),st(ut,null,[_t(jM),_t(Dy),_t(uy),_t(nE)],64))}},rE=[{path:"/",component:iE}],sE=f1({history:H_(),routes:rE});W3(u_).use(sE).use(K6).mount("body");
